...
module Types =
    ...
    type IButtonsProperty = interface end
    ...
    type IXaxis2Property = interface end
    type IXaxis3Property = interface end
    type IXaxis4Property = interface end
    type IXaxis5Property = interface end
    type IXaxisProperty = interface end
    type IXbinsProperty = interface end
    type IYProperty = interface end
    type IYaxis2Property = interface end
    type IYaxis3Property = interface end
    type IYaxis4Property = interface end
    type IYaxis5Property = interface end
