...
module xaxis2 =
    ...
    type spikemode =
        ...
        static member inline acrossAndToaxis = Interop.mkXaxis2Attr "spikemode" "across+toaxis"
        static member inline marker = Interop.mkXaxis2Attr "spikemode" "marker"
        static member inline markerAndAcross = Interop.mkXaxis2Attr "spikemode" "marker+across"
        static member inline markerAndAcrossToaxis = Interop.mkXaxis2Attr "spikemode" "marker+across+toaxis"
        static member inline markerAndToaxis = Interop.mkXaxis2Attr "spikemode" "marker+toaxis"
