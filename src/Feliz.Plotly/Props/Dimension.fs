...
type dimension =
    ...
    /// Sets the order in which categories in this dimension appear. Only has an effect if `categoryorder` is set to *array*. Used with `categoryorder`.
    static member inline categoryarray (values: seq<seq<bool>>) = Interop.mkDimensionAttr "categoryarray" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the order in which categories in this dimension appear. Only has an effect if `categoryorder` is set to *array*. Used with `categoryorder`.
    static member inline categoryarray (values: seq<bool list>) = Interop.mkDimensionAttr "categoryarray" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the order in which categories in this dimension appear. Only has an effect if `categoryorder` is set to *array*. Used with `categoryorder`.
    static member inline categoryarray (values: seq<bool []>) = Interop.mkDimensionAttr "categoryarray" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the order in which categories in this dimension appear. Only has an effect if `categoryorder` is set to *array*. Used with `categoryorder`.
    static member inline categoryarray (values: seq<seq<string>>) = Interop.mkDimensionAttr "categoryarray" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the order in which categories in this dimension appear. Only has an effect if `categoryorder` is set to *array*. Used with `categoryorder`.
    static member inline categoryarray (values: seq<string list>) = Interop.mkDimensionAttr "categoryarray" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the order in which categories in this dimension appear. Only has an effect if `categoryorder` is set to *array*. Used with `categoryorder`.
    static member inline categoryarray (values: seq<string []>) = Interop.mkDimensionAttr "categoryarray" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the order in which categories in this dimension appear. Only has an effect if `categoryorder` is set to *array*. Used with `categoryorder`.
    static member inline categoryarray (values: seq<seq<int>>) = Interop.mkDimensionAttr "categoryarray" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the order in which categories in this dimension appear. Only has an effect if `categoryorder` is set to *array*. Used with `categoryorder`.
    static member inline categoryarray (values: seq<int list>) = Interop.mkDimensionAttr "categoryarray" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the order in which categories in this dimension appear. Only has an effect if `categoryorder` is set to *array*. Used with `categoryorder`.
    static member inline categoryarray (values: seq<int []>) = Interop.mkDimensionAttr "categoryarray" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the order in which categories in this dimension appear. Only has an effect if `categoryorder` is set to *array*. Used with `categoryorder`.
    static member inline categoryarray (values: seq<seq<float>>) = Interop.mkDimensionAttr "categoryarray" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the order in which categories in this dimension appear. Only has an effect if `categoryorder` is set to *array*. Used with `categoryorder`.
    static member inline categoryarray (values: seq<float list>) = Interop.mkDimensionAttr "categoryarray" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the order in which categories in this dimension appear. Only has an effect if `categoryorder` is set to *array*. Used with `categoryorder`.
    static member inline categoryarray (values: seq<float []>) = Interop.mkDimensionAttr "categoryarray" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the order in which categories in this dimension appear. Only has an effect if `categoryorder` is set to *array*. Used with `categoryorder`.
    static member inline categoryarray (values: seq<PlotData>) = Interop.mkDimensionAttr "categoryarray" (values |> Seq.map PlotData.asDataResize |> ResizeArray)
    /// Sets the order in which categories in this dimension appear. Only has an effect if `categoryorder` is set to *array*. Used with `categoryorder`.
    ...
    static member inline ticktext (value: bool) = Interop.mkDimensionAttr "ticktext" (value |> Array.singleton |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<bool>) = Interop.mkDimensionAttr "ticktext" (values |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    ...
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<float>) = Interop.mkDimensionAttr "ticktext" (values |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (value: int) = Interop.mkDimensionAttr "ticktext" (value |> Array.singleton |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<int>) = Interop.mkDimensionAttr "ticktext" (values |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (value: string) = Interop.mkDimensionAttr "ticktext" (value |> Array.singleton |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<string>) = Interop.mkDimensionAttr "ticktext" (values |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<seq<bool>>) = Interop.mkDimensionAttr "ticktext" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<bool list>) = Interop.mkDimensionAttr "ticktext" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<bool []>) = Interop.mkDimensionAttr "ticktext" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<seq<string>>) = Interop.mkDimensionAttr "ticktext" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<string list>) = Interop.mkDimensionAttr "ticktext" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<string []>) = Interop.mkDimensionAttr "ticktext" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<seq<int>>) = Interop.mkDimensionAttr "ticktext" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<int list>) = Interop.mkDimensionAttr "ticktext" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<int []>) = Interop.mkDimensionAttr "ticktext" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<seq<float>>) = Interop.mkDimensionAttr "ticktext" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<float list>) = Interop.mkDimensionAttr "ticktext" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<float []>) = Interop.mkDimensionAttr "ticktext" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    static member inline ticktext (values: seq<PlotData>) = Interop.mkDimensionAttr "ticktext" (values |> Seq.map PlotData.asDataResize |> ResizeArray)
    /// Sets the text displayed at the ticks position via `tickvals`.
    ...
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<bool>) = Interop.mkDimensionAttr "tickvals" (values |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    ...
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<float>) = Interop.mkDimensionAttr "tickvals" (values |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (value: int) = Interop.mkDimensionAttr "tickvals" (value |> Array.singleton |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<int>) = Interop.mkDimensionAttr "tickvals" (values |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (value: string) = Interop.mkDimensionAttr "tickvals" (value |> Array.singleton |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<string>) = Interop.mkDimensionAttr "tickvals" (values |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<seq<bool>>) = Interop.mkDimensionAttr "tickvals" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<bool list>) = Interop.mkDimensionAttr "tickvals" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<bool []>) = Interop.mkDimensionAttr "tickvals" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<seq<string>>) = Interop.mkDimensionAttr "tickvals" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<string list>) = Interop.mkDimensionAttr "tickvals" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<string []>) = Interop.mkDimensionAttr "tickvals" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<seq<int>>) = Interop.mkDimensionAttr "tickvals" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<int list>) = Interop.mkDimensionAttr "tickvals" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<int []>) = Interop.mkDimensionAttr "tickvals" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<seq<float>>) = Interop.mkDimensionAttr "tickvals" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<float list>) = Interop.mkDimensionAttr "tickvals" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<float []>) = Interop.mkDimensionAttr "tickvals" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    static member inline tickvals (values: seq<PlotData>) = Interop.mkDimensionAttr "tickvals" (values |> Seq.map PlotData.asDataResize |> ResizeArray)
    /// Sets the values at which ticks on this axis appear.
    ...
    /// Sets the dimension values to be plotted.
    static member inline values (values: seq<seq<bool>>) = Interop.mkDimensionAttr "values" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the dimension values to be plotted.
    static member inline values (values: seq<bool list>) = Interop.mkDimensionAttr "values" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the dimension values to be plotted.
    static member inline values (values: seq<bool []>) = Interop.mkDimensionAttr "values" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the dimension values to be plotted.
    static member inline values (values: seq<seq<string>>) = Interop.mkDimensionAttr "values" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the dimension values to be plotted.
    static member inline values (values: seq<string list>) = Interop.mkDimensionAttr "values" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the dimension values to be plotted.
    static member inline values (values: seq<string []>) = Interop.mkDimensionAttr "values" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the dimension values to be plotted.
    static member inline values (values: seq<seq<int>>) = Interop.mkDimensionAttr "values" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the dimension values to be plotted.
    static member inline values (values: seq<int list>) = Interop.mkDimensionAttr "values" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the dimension values to be plotted.
    static member inline values (values: seq<int []>) = Interop.mkDimensionAttr "values" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the dimension values to be plotted.
    static member inline values (values: seq<seq<float>>) = Interop.mkDimensionAttr "values" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the dimension values to be plotted.
    static member inline values (values: seq<float list>) = Interop.mkDimensionAttr "values" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the dimension values to be plotted.
    static member inline values (values: seq<float []>) = Interop.mkDimensionAttr "values" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the dimension values to be plotted.
    static member inline values (values: seq<PlotData>) = Interop.mkDimensionAttr "values" (values |> Seq.map PlotData.asDataResize |> ResizeArray)
    /// Sets the dimension values to be plotted.
