...
type z =
    ...
    /// Specifies the location(s) of slices on the axis. When not specified slices would be created for all points of the axis z except start and end.
    static member inline locations (values: seq<seq<bool>>) = Interop.mkZAttr "locations" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Specifies the location(s) of slices on the axis. When not specified slices would be created for all points of the axis z except start and end.
    static member inline locations (values: seq<bool list>) = Interop.mkZAttr "locations" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Specifies the location(s) of slices on the axis. When not specified slices would be created for all points of the axis z except start and end.
    static member inline locations (values: seq<bool []>) = Interop.mkZAttr "locations" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Specifies the location(s) of slices on the axis. When not specified slices would be created for all points of the axis z except start and end.
    static member inline locations (values: seq<seq<string>>) = Interop.mkZAttr "locations" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Specifies the location(s) of slices on the axis. When not specified slices would be created for all points of the axis z except start and end.
    static member inline locations (values: seq<string list>) = Interop.mkZAttr "locations" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Specifies the location(s) of slices on the axis. When not specified slices would be created for all points of the axis z except start and end.
    static member inline locations (values: seq<string []>) = Interop.mkZAttr "locations" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Specifies the location(s) of slices on the axis. When not specified slices would be created for all points of the axis z except start and end.
    static member inline locations (values: seq<seq<int>>) = Interop.mkZAttr "locations" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Specifies the location(s) of slices on the axis. When not specified slices would be created for all points of the axis z except start and end.
    static member inline locations (values: seq<int list>) = Interop.mkZAttr "locations" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Specifies the location(s) of slices on the axis. When not specified slices would be created for all points of the axis z except start and end.
    static member inline locations (values: seq<int option []>) = Interop.mkZAttr "locations" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Specifies the location(s) of slices on the axis. When not specified slices would be created for all points of the axis z except start and end.
    static member inline locations (values: seq<seq<float>>) = Interop.mkZAttr "locations" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Specifies the location(s) of slices on the axis. When not specified slices would be created for all points of the axis z except start and end.
    static member inline locations (values: seq<float list>) = Interop.mkZAttr "locations" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Specifies the location(s) of slices on the axis. When not specified slices would be created for all points of the axis z except start and end.
