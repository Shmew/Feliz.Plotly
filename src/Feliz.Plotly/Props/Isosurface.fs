...
type isosurface =
    ...
    static member inline coloraxis (values: seq<string>) = Interop.mkIsosurfaceAttr "coloraxis" (values |> Array.ofSeq)
    ...
    static member inline scene (values: seq<string>) = Interop.mkIsosurfaceAttr "scene" (values |> Array.ofSeq)
