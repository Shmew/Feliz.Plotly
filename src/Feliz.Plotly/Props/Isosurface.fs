...
type isosurface =
    ...
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<bool>>) = Interop.mkIsosurfaceAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<bool list>) = Interop.mkIsosurfaceAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<bool []>) = Interop.mkIsosurfaceAttr "ids" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<string>>) = Interop.mkIsosurfaceAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<string list>) = Interop.mkIsosurfaceAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<string []>) = Interop.mkIsosurfaceAttr "ids" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<int>>) = Interop.mkIsosurfaceAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int list>) = Interop.mkIsosurfaceAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int option []>) = Interop.mkIsosurfaceAttr "ids" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<float>>) = Interop.mkIsosurfaceAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<float list>) = Interop.mkIsosurfaceAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    ...
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<bool>>) = Interop.mkIsosurfaceAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<bool list>) = Interop.mkIsosurfaceAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<bool []>) = Interop.mkIsosurfaceAttr "customdata" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<string>>) = Interop.mkIsosurfaceAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<string list>) = Interop.mkIsosurfaceAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<string []>) = Interop.mkIsosurfaceAttr "customdata" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<int>>) = Interop.mkIsosurfaceAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int list>) = Interop.mkIsosurfaceAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int option []>) = Interop.mkIsosurfaceAttr "customdata" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<float>>) = Interop.mkIsosurfaceAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<float list>) = Interop.mkIsosurfaceAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    ...
    /// Controls persistence of some user-driven changes to the trace: `constraintrange` in `parcoords` traces, as well as some `editable: true` modifications such as `name` and `colorbar.title`. Defaults to `layout.uirevision`. Note that other user-driven trace attribute changes are controlled by `layout` attributes: `trace.visible` is controlled by `layout.legend.uirevision`, `selectedpoints` is controlled by `layout.selectionrevision`, and `colorbar.(x|y)` (accessible with `config: {editable: true}`) is controlled by `layout.editrevision`. Trace changes are tracked by `uid`, which only falls back on trace index if no `uid` is provided. So if your app can add/remove traces before the end of the `data` array, such that the same trace has a different index, you can still preserve user-driven changes if you give each trace a `uid` that stays with it as it moves.
    static member inline uirevision (values: seq<System.DateTime>) = Interop.mkIsosurfaceAttr "uirevision" (values |> Array.ofSeq)
    /// Controls persistence of some user-driven changes to the trace: `constraintrange` in `parcoords` traces, as well as some `editable: true` modifications such as `name` and `colorbar.title`. Defaults to `layout.uirevision`. Note that other user-driven trace attribute changes are controlled by `layout` attributes: `trace.visible` is controlled by `layout.legend.uirevision`, `selectedpoints` is controlled by `layout.selectionrevision`, and `colorbar.(x|y)` (accessible with `config: {editable: true}`) is controlled by `layout.editrevision`. Trace changes are tracked by `uid`, which only falls back on trace index if no `uid` is provided. So if your app can add/remove traces before the end of the `data` array, such that the same trace has a different index, you can still preserve user-driven changes if you give each trace a `uid` that stays with it as it moves.
    ...
    /// Sets the X coordinates of the vertices on X axis.
    static member inline x (values: seq<bool list>) = Interop.mkIsosurfaceAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the X coordinates of the vertices on X axis.
    static member inline x (values: seq<bool []>) = Interop.mkIsosurfaceAttr "x" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the X coordinates of the vertices on X axis.
    static member inline x (values: seq<seq<string>>) = Interop.mkIsosurfaceAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the X coordinates of the vertices on X axis.
    static member inline x (values: seq<string list>) = Interop.mkIsosurfaceAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the X coordinates of the vertices on X axis.
    static member inline x (values: seq<string []>) = Interop.mkIsosurfaceAttr "x" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the X coordinates of the vertices on X axis.
    static member inline x (values: seq<seq<int>>) = Interop.mkIsosurfaceAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the X coordinates of the vertices on X axis.
    static member inline x (values: seq<int list>) = Interop.mkIsosurfaceAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the X coordinates of the vertices on X axis.
    static member inline x (values: seq<int option []>) = Interop.mkIsosurfaceAttr "x" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the X coordinates of the vertices on X axis.
    static member inline x (values: seq<seq<float>>) = Interop.mkIsosurfaceAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the X coordinates of the vertices on X axis.
    static member inline x (values: seq<float list>) = Interop.mkIsosurfaceAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the X coordinates of the vertices on X axis.
    ...
    /// Sets the Y coordinates of the vertices on Y axis.
    static member inline y (values: seq<bool list>) = Interop.mkIsosurfaceAttr "y" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices on Y axis.
    static member inline y (values: seq<bool []>) = Interop.mkIsosurfaceAttr "y" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices on Y axis.
    static member inline y (values: seq<seq<string>>) = Interop.mkIsosurfaceAttr "y" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices on Y axis.
    static member inline y (values: seq<string list>) = Interop.mkIsosurfaceAttr "y" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices on Y axis.
    static member inline y (values: seq<string []>) = Interop.mkIsosurfaceAttr "y" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices on Y axis.
    static member inline y (values: seq<seq<int>>) = Interop.mkIsosurfaceAttr "y" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices on Y axis.
    static member inline y (values: seq<int list>) = Interop.mkIsosurfaceAttr "y" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices on Y axis.
    static member inline y (values: seq<int option []>) = Interop.mkIsosurfaceAttr "y" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices on Y axis.
    static member inline y (values: seq<seq<float>>) = Interop.mkIsosurfaceAttr "y" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices on Y axis.
    static member inline y (values: seq<float list>) = Interop.mkIsosurfaceAttr "y" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices on Y axis.
    ...
    /// Sets the Z coordinates of the vertices on Z axis.
    static member inline z (values: seq<bool list>) = Interop.mkIsosurfaceAttr "z" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices on Z axis.
    static member inline z (values: seq<bool []>) = Interop.mkIsosurfaceAttr "z" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices on Z axis.
    static member inline z (values: seq<seq<string>>) = Interop.mkIsosurfaceAttr "z" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices on Z axis.
    static member inline z (values: seq<string list>) = Interop.mkIsosurfaceAttr "z" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices on Z axis.
    static member inline z (values: seq<string []>) = Interop.mkIsosurfaceAttr "z" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices on Z axis.
    static member inline z (values: seq<seq<int>>) = Interop.mkIsosurfaceAttr "z" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices on Z axis.
    static member inline z (values: seq<int list>) = Interop.mkIsosurfaceAttr "z" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices on Z axis.
    static member inline z (values: seq<int option []>) = Interop.mkIsosurfaceAttr "z" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices on Z axis.
    static member inline z (values: seq<seq<float>>) = Interop.mkIsosurfaceAttr "z" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices on Z axis.
    static member inline z (values: seq<float list>) = Interop.mkIsosurfaceAttr "z" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices on Z axis.
    ...
    /// Sets the 4th dimension (value) of the vertices.
    static member inline value (values: seq<bool list>) = Interop.mkIsosurfaceAttr "value" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the 4th dimension (value) of the vertices.
    static member inline value (values: seq<bool []>) = Interop.mkIsosurfaceAttr "value" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the 4th dimension (value) of the vertices.
    static member inline value (values: seq<seq<string>>) = Interop.mkIsosurfaceAttr "value" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the 4th dimension (value) of the vertices.
    static member inline value (values: seq<string list>) = Interop.mkIsosurfaceAttr "value" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the 4th dimension (value) of the vertices.
    static member inline value (values: seq<string []>) = Interop.mkIsosurfaceAttr "value" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the 4th dimension (value) of the vertices.
    static member inline value (values: seq<seq<int>>) = Interop.mkIsosurfaceAttr "value" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the 4th dimension (value) of the vertices.
    static member inline value (values: seq<int list>) = Interop.mkIsosurfaceAttr "value" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the 4th dimension (value) of the vertices.
    static member inline value (values: seq<int option []>) = Interop.mkIsosurfaceAttr "value" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the 4th dimension (value) of the vertices.
    static member inline value (values: seq<seq<float>>) = Interop.mkIsosurfaceAttr "value" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the 4th dimension (value) of the vertices.
    static member inline value (values: seq<float list>) = Interop.mkIsosurfaceAttr "value" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the 4th dimension (value) of the vertices.
    ...
    /// Sets the colorscale. The colorscale must be an array containing arrays mapping a normalized value to an rgb, rgba, hex, hsl, hsv, or named color string. At minimum, a mapping for the lowest (0) and highest (1) values are required. For example, `[[0, 'rgb(0,0,255)'], [1, 'rgb(255,0,0)']]`. To control the bounds of the colorscale in color space, use`cmin` and `cmax`. Alternatively, `colorscale` may be a palette name string of the following list: Greys,YlGnBu,Greens,YlOrRd,Bluered,RdBu,Reds,Blues,Picnic,Rainbow,Portland,Jet,Hot,Blackbody,Earth,Electric,Viridis,Cividis.
    static member inline colorscale (values: seq<string list>) = Interop.mkIsosurfaceAttr "colorscale" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
