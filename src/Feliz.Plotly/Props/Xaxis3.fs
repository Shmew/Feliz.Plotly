...
module xaxis3 =
    ...
    type spikemode =
        ...
        static member inline acrossAndToaxis = Interop.mkXaxis3Attr "spikemode" "across+toaxis"
        static member inline marker = Interop.mkXaxis3Attr "spikemode" "marker"
        static member inline markerAndAcross = Interop.mkXaxis3Attr "spikemode" "marker+across"
        static member inline markerAndAcrossToaxis = Interop.mkXaxis3Attr "spikemode" "marker+across+toaxis"
        static member inline markerAndToaxis = Interop.mkXaxis3Attr "spikemode" "marker+toaxis"
