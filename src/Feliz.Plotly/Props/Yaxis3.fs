...
module yaxis3 =
    ...
    type spikemode =
        ...
        static member inline acrossAndToaxis = Interop.mkYaxis3Attr "spikemode" "across+toaxis"
        static member inline marker = Interop.mkYaxis3Attr "spikemode" "marker"
        static member inline markerAndAcross = Interop.mkYaxis3Attr "spikemode" "marker+across"
        static member inline markerAndAcrossToaxis = Interop.mkYaxis3Attr "spikemode" "marker+across+toaxis"
        static member inline markerAndToaxis = Interop.mkYaxis3Attr "spikemode" "marker+toaxis"
