...
type streamtube =
    ...
    static member inline customdata (value: bool) = Interop.mkStreamtubeAttr "customdata" (value |> Array.singleton |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    ...
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (value: int) = Interop.mkStreamtubeAttr "customdata" (value |> Array.singleton |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int>) = Interop.mkStreamtubeAttr "customdata" (values |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (value: string) = Interop.mkStreamtubeAttr "customdata" (value |> Array.singleton |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    ...
    static member inline ids (value: bool) = Interop.mkStreamtubeAttr "ids" (value |> Array.singleton |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    ...
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (value: int) = Interop.mkStreamtubeAttr "ids" (value |> Array.singleton |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int>) = Interop.mkStreamtubeAttr "ids" (values |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (value: string) = Interop.mkStreamtubeAttr "ids" (value |> Array.singleton |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    ...
    static member inline u (value: bool) = Interop.mkStreamtubeAttr "u" (value |> Array.singleton |> ResizeArray)
    /// Sets the x components of the vector field.
    ...
    /// Sets the x components of the vector field.
    static member inline u (value: int) = Interop.mkStreamtubeAttr "u" (value |> Array.singleton |> ResizeArray)
    /// Sets the x components of the vector field.
    static member inline u (values: seq<int>) = Interop.mkStreamtubeAttr "u" (values |> ResizeArray)
    /// Sets the x components of the vector field.
    static member inline u (value: string) = Interop.mkStreamtubeAttr "u" (value |> Array.singleton |> ResizeArray)
    /// Sets the x components of the vector field.
    ...
    static member inline uhoverformat (value: string) = Interop.mkStreamtubeAttr "uhoverformat" value
    ...
    static member inline v (value: bool) = Interop.mkStreamtubeAttr "v" (value |> Array.singleton |> ResizeArray)
    /// Sets the y components of the vector field.
    ...
    /// Sets the y components of the vector field.
    static member inline v (value: int) = Interop.mkStreamtubeAttr "v" (value |> Array.singleton |> ResizeArray)
    /// Sets the y components of the vector field.
    static member inline v (values: seq<int>) = Interop.mkStreamtubeAttr "v" (values |> ResizeArray)
    /// Sets the y components of the vector field.
    static member inline v (value: string) = Interop.mkStreamtubeAttr "v" (value |> Array.singleton |> ResizeArray)
    /// Sets the y components of the vector field.
    ...
    static member inline vhoverformat (value: string) = Interop.mkStreamtubeAttr "vhoverformat" value
    ...
    static member inline w (value: bool) = Interop.mkStreamtubeAttr "w" (value |> Array.singleton |> ResizeArray)
    /// Sets the z components of the vector field.
    ...
    /// Sets the z components of the vector field.
    static member inline w (value: int) = Interop.mkStreamtubeAttr "w" (value |> Array.singleton |> ResizeArray)
    /// Sets the z components of the vector field.
    static member inline w (values: seq<int>) = Interop.mkStreamtubeAttr "w" (values |> ResizeArray)
    /// Sets the z components of the vector field.
    static member inline w (value: string) = Interop.mkStreamtubeAttr "w" (value |> Array.singleton |> ResizeArray)
    /// Sets the z components of the vector field.
    ...
    static member inline whoverformat (value: string) = Interop.mkStreamtubeAttr "whoverformat" value
    ...
    static member inline xhoverformat (value: string) = Interop.mkStreamtubeAttr "xhoverformat" value
    ...
    static member inline yhoverformat (value: string) = Interop.mkStreamtubeAttr "yhoverformat" value
    ...
    static member inline zhoverformat (value: string) = Interop.mkStreamtubeAttr "zhoverformat" value
