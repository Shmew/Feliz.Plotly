...
type scatterpolar =
    ...
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int []>) = Interop.mkScatterpolarAttr "ids" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    ...
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int []>) = Interop.mkScatterpolarAttr "customdata" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    ...
    /// Sets the radial coordinates
    static member inline r (values: seq<int []>) = Interop.mkScatterpolarAttr "r" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the radial coordinates
    ...
    /// Sets the angular coordinates
    static member inline theta (values: seq<int []>) = Interop.mkScatterpolarAttr "theta" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the angular coordinates
