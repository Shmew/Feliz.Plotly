...
type histogram2d =
    ...
    static member inline ids (value: bool) = Interop.mkHistogram2dAttr "ids" value
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<bool>) = Interop.mkHistogram2dAttr "ids" (values |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (value: System.DateTime) = Interop.mkHistogram2dAttr "ids" value
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<System.DateTime>) = Interop.mkHistogram2dAttr "ids" (values |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (value: int) = Interop.mkHistogram2dAttr "ids" value
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int>) = Interop.mkHistogram2dAttr "ids" (values |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (value: float) = Interop.mkHistogram2dAttr "ids" value
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<float>) = Interop.mkHistogram2dAttr "ids" (values |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (value: string) = Interop.mkHistogram2dAttr "ids" value
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<string>) = Interop.mkHistogram2dAttr "ids" (values |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<bool>>) = Interop.mkHistogram2dAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<bool list>) = Interop.mkHistogram2dAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<bool []>) = Interop.mkHistogram2dAttr "ids" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<string>>) = Interop.mkHistogram2dAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<string list>) = Interop.mkHistogram2dAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<string []>) = Interop.mkHistogram2dAttr "ids" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<int>>) = Interop.mkHistogram2dAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int list>) = Interop.mkHistogram2dAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int option []>) = Interop.mkHistogram2dAttr "ids" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<float>>) = Interop.mkHistogram2dAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<float list>) = Interop.mkHistogram2dAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    ...
    static member inline customdata (value: bool) = Interop.mkHistogram2dAttr "customdata" value
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<bool>) = Interop.mkHistogram2dAttr "customdata" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (value: System.DateTime) = Interop.mkHistogram2dAttr "customdata" value
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<System.DateTime>) = Interop.mkHistogram2dAttr "customdata" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (value: int) = Interop.mkHistogram2dAttr "customdata" value
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int>) = Interop.mkHistogram2dAttr "customdata" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (value: float) = Interop.mkHistogram2dAttr "customdata" value
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<float>) = Interop.mkHistogram2dAttr "customdata" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (value: string) = Interop.mkHistogram2dAttr "customdata" value
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<string>) = Interop.mkHistogram2dAttr "customdata" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<bool>>) = Interop.mkHistogram2dAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<bool list>) = Interop.mkHistogram2dAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<bool []>) = Interop.mkHistogram2dAttr "customdata" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<string>>) = Interop.mkHistogram2dAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<string list>) = Interop.mkHistogram2dAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<string []>) = Interop.mkHistogram2dAttr "customdata" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<int>>) = Interop.mkHistogram2dAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int list>) = Interop.mkHistogram2dAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int option []>) = Interop.mkHistogram2dAttr "customdata" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<float>>) = Interop.mkHistogram2dAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<float list>) = Interop.mkHistogram2dAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    ...
    /// Controls persistence of some user-driven changes to the trace: `constraintrange` in `parcoords` traces, as well as some `editable: true` modifications such as `name` and `colorbar.title`. Defaults to `layout.uirevision`. Note that other user-driven trace attribute changes are controlled by `layout` attributes: `trace.visible` is controlled by `layout.legend.uirevision`, `selectedpoints` is controlled by `layout.selectionrevision`, and `colorbar.(x|y)` (accessible with `config: {editable: true}`) is controlled by `layout.editrevision`. Trace changes are tracked by `uid`, which only falls back on trace index if no `uid` is provided. So if your app can add/remove traces before the end of the `data` array, such that the same trace has a different index, you can still preserve user-driven changes if you give each trace a `uid` that stays with it as it moves.
    static member inline uirevision (values: seq<System.DateTime>) = Interop.mkHistogram2dAttr "uirevision" (values |> Array.ofSeq)
    /// Controls persistence of some user-driven changes to the trace: `constraintrange` in `parcoords` traces, as well as some `editable: true` modifications such as `name` and `colorbar.title`. Defaults to `layout.uirevision`. Note that other user-driven trace attribute changes are controlled by `layout` attributes: `trace.visible` is controlled by `layout.legend.uirevision`, `selectedpoints` is controlled by `layout.selectionrevision`, and `colorbar.(x|y)` (accessible with `config: {editable: true}`) is controlled by `layout.editrevision`. Trace changes are tracked by `uid`, which only falls back on trace index if no `uid` is provided. So if your app can add/remove traces before the end of the `data` array, such that the same trace has a different index, you can still preserve user-driven changes if you give each trace a `uid` that stays with it as it moves.
    ...
    static member inline x (value: bool) = Interop.mkHistogram2dAttr "x" value
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<bool>) = Interop.mkHistogram2dAttr "x" (values |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    static member inline x (value: System.DateTime) = Interop.mkHistogram2dAttr "x" value
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<System.DateTime>) = Interop.mkHistogram2dAttr "x" (values |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    static member inline x (value: int) = Interop.mkHistogram2dAttr "x" value
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<int>) = Interop.mkHistogram2dAttr "x" (values |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    static member inline x (value: float) = Interop.mkHistogram2dAttr "x" value
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<float>) = Interop.mkHistogram2dAttr "x" (values |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    static member inline x (value: string) = Interop.mkHistogram2dAttr "x" value
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<string>) = Interop.mkHistogram2dAttr "x" (values |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<seq<bool>>) = Interop.mkHistogram2dAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<bool list>) = Interop.mkHistogram2dAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<bool []>) = Interop.mkHistogram2dAttr "x" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<seq<string>>) = Interop.mkHistogram2dAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<string list>) = Interop.mkHistogram2dAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<string []>) = Interop.mkHistogram2dAttr "x" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<seq<int>>) = Interop.mkHistogram2dAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<int list>) = Interop.mkHistogram2dAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<int option []>) = Interop.mkHistogram2dAttr "x" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<seq<float>>) = Interop.mkHistogram2dAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    static member inline x (values: seq<float list>) = Interop.mkHistogram2dAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the x axis.
    ...
    static member inline y (value: bool) = Interop.mkHistogram2dAttr "y" value
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<bool>) = Interop.mkHistogram2dAttr "y" (values |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    static member inline y (value: System.DateTime) = Interop.mkHistogram2dAttr "y" value
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<System.DateTime>) = Interop.mkHistogram2dAttr "y" (values |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    static member inline y (value: int) = Interop.mkHistogram2dAttr "y" value
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<int>) = Interop.mkHistogram2dAttr "y" (values |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    static member inline y (value: float) = Interop.mkHistogram2dAttr "y" value
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<float>) = Interop.mkHistogram2dAttr "y" (values |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    static member inline y (value: string) = Interop.mkHistogram2dAttr "y" value
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<string>) = Interop.mkHistogram2dAttr "y" (values |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<seq<bool>>) = Interop.mkHistogram2dAttr "y" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<bool list>) = Interop.mkHistogram2dAttr "y" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<bool []>) = Interop.mkHistogram2dAttr "y" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<seq<string>>) = Interop.mkHistogram2dAttr "y" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<string list>) = Interop.mkHistogram2dAttr "y" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<string []>) = Interop.mkHistogram2dAttr "y" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<seq<int>>) = Interop.mkHistogram2dAttr "y" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<int list>) = Interop.mkHistogram2dAttr "y" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<int option []>) = Interop.mkHistogram2dAttr "y" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<seq<float>>) = Interop.mkHistogram2dAttr "y" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    static member inline y (values: seq<float list>) = Interop.mkHistogram2dAttr "y" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the sample data to be binned on the y axis.
    ...
    static member inline z (value: bool) = Interop.mkHistogram2dAttr "z" value
    /// Sets the aggregation data.
    static member inline z (values: seq<bool>) = Interop.mkHistogram2dAttr "z" (values |> Array.ofSeq)
    /// Sets the aggregation data.
    static member inline z (value: System.DateTime) = Interop.mkHistogram2dAttr "z" value
    /// Sets the aggregation data.
    static member inline z (values: seq<System.DateTime>) = Interop.mkHistogram2dAttr "z" (values |> Array.ofSeq)
    /// Sets the aggregation data.
    static member inline z (value: int) = Interop.mkHistogram2dAttr "z" value
    /// Sets the aggregation data.
    static member inline z (values: seq<int>) = Interop.mkHistogram2dAttr "z" (values |> Array.ofSeq)
    /// Sets the aggregation data.
    static member inline z (value: float) = Interop.mkHistogram2dAttr "z" value
    /// Sets the aggregation data.
    static member inline z (values: seq<float>) = Interop.mkHistogram2dAttr "z" (values |> Array.ofSeq)
    /// Sets the aggregation data.
    static member inline z (value: string) = Interop.mkHistogram2dAttr "z" value
    /// Sets the aggregation data.
    static member inline z (values: seq<string>) = Interop.mkHistogram2dAttr "z" (values |> Array.ofSeq)
    /// Sets the aggregation data.
    static member inline z (values: seq<seq<bool>>) = Interop.mkHistogram2dAttr "z" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the aggregation data.
    static member inline z (values: seq<bool list>) = Interop.mkHistogram2dAttr "z" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the aggregation data.
    static member inline z (values: seq<bool []>) = Interop.mkHistogram2dAttr "z" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the aggregation data.
    static member inline z (values: seq<seq<string>>) = Interop.mkHistogram2dAttr "z" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the aggregation data.
    static member inline z (values: seq<string list>) = Interop.mkHistogram2dAttr "z" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the aggregation data.
    static member inline z (values: seq<string []>) = Interop.mkHistogram2dAttr "z" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the aggregation data.
    static member inline z (values: seq<seq<int>>) = Interop.mkHistogram2dAttr "z" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the aggregation data.
    static member inline z (values: seq<int list>) = Interop.mkHistogram2dAttr "z" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the aggregation data.
    static member inline z (values: seq<int option []>) = Interop.mkHistogram2dAttr "z" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the aggregation data.
    static member inline z (values: seq<seq<float>>) = Interop.mkHistogram2dAttr "z" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the aggregation data.
    static member inline z (values: seq<float list>) = Interop.mkHistogram2dAttr "z" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the aggregation data.
    ...
    /// Sets the colorscale. The colorscale must be an array containing arrays mapping a normalized value to an rgb, rgba, hex, hsl, hsv, or named color string. At minimum, a mapping for the lowest (0) and highest (1) values are required. For example, `[[0, 'rgb(0,0,255)'], [1, 'rgb(255,0,0)']]`. To control the bounds of the colorscale in color space, use`zmin` and `zmax`. Alternatively, `colorscale` may be a palette name string of the following list: Greys,YlGnBu,Greens,YlOrRd,Bluered,RdBu,Reds,Blues,Picnic,Rainbow,Portland,Jet,Hot,Blackbody,Earth,Electric,Viridis,Cividis.
    static member inline colorscale (values: seq<string list>) = Interop.mkHistogram2dAttr "colorscale" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
