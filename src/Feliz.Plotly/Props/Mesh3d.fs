...
type mesh3d =
    ...
    static member inline ids (value: bool) = Interop.mkMesh3dAttr "ids" (value |> Array.singleton)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<bool>) = Interop.mkMesh3dAttr "ids" (values |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (value: string) = Interop.mkMesh3dAttr "ids" (value |> Array.singleton)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<string>) = Interop.mkMesh3dAttr "ids" (values |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (value: int) = Interop.mkMesh3dAttr "ids" (value |> Array.singleton)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int>) = Interop.mkMesh3dAttr "ids" (values |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (value: float) = Interop.mkMesh3dAttr "ids" (value |> Array.singleton)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<float>) = Interop.mkMesh3dAttr "ids" (values |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<bool>>) = Interop.mkMesh3dAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<bool list>) = Interop.mkMesh3dAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<bool []>) = Interop.mkMesh3dAttr "ids" (values |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<string>>) = Interop.mkMesh3dAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<string list>) = Interop.mkMesh3dAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<string []>) = Interop.mkMesh3dAttr "ids" (values |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<int>>) = Interop.mkMesh3dAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int list>) = Interop.mkMesh3dAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int []>) = Interop.mkMesh3dAttr "ids" (values |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<float>>) = Interop.mkMesh3dAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<float list>) = Interop.mkMesh3dAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<float []>) = Interop.mkMesh3dAttr "ids" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (value: bool) = Interop.mkMesh3dAttr "customdata" (value |> Array.singleton)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<bool>) = Interop.mkMesh3dAttr "customdata" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (value: string) = Interop.mkMesh3dAttr "customdata" (value |> Array.singleton)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<string>) = Interop.mkMesh3dAttr "customdata" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (value: int) = Interop.mkMesh3dAttr "customdata" (value |> Array.singleton)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int>) = Interop.mkMesh3dAttr "customdata" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (value: float) = Interop.mkMesh3dAttr "customdata" (value |> Array.singleton)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<float>) = Interop.mkMesh3dAttr "customdata" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<bool>>) = Interop.mkMesh3dAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<bool list>) = Interop.mkMesh3dAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<bool []>) = Interop.mkMesh3dAttr "customdata" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<string>>) = Interop.mkMesh3dAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<string list>) = Interop.mkMesh3dAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<string []>) = Interop.mkMesh3dAttr "customdata" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<int>>) = Interop.mkMesh3dAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int list>) = Interop.mkMesh3dAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int []>) = Interop.mkMesh3dAttr "customdata" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<float>>) = Interop.mkMesh3dAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<float list>) = Interop.mkMesh3dAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<float []>) = Interop.mkMesh3dAttr "customdata" (values |> Array.ofSeq)
    ...
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (value: string) = Interop.mkMesh3dAttr "x" (value |> Array.singleton)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (values: seq<string>) = Interop.mkMesh3dAttr "x" (values |> Array.ofSeq)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (value: int) = Interop.mkMesh3dAttr "x" (value |> Array.singleton)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (values: seq<int>) = Interop.mkMesh3dAttr "x" (values |> Array.ofSeq)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (value: float) = Interop.mkMesh3dAttr "x" (value |> Array.singleton)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (values: seq<float>) = Interop.mkMesh3dAttr "x" (values |> Array.ofSeq)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (values: seq<seq<bool>>) = Interop.mkMesh3dAttr "x" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (values: seq<bool list>) = Interop.mkMesh3dAttr "x" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (values: seq<bool []>) = Interop.mkMesh3dAttr "x" (values |> Array.ofSeq)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (values: seq<seq<string>>) = Interop.mkMesh3dAttr "x" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (values: seq<string list>) = Interop.mkMesh3dAttr "x" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (values: seq<string []>) = Interop.mkMesh3dAttr "x" (values |> Array.ofSeq)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (values: seq<seq<int>>) = Interop.mkMesh3dAttr "x" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (values: seq<int list>) = Interop.mkMesh3dAttr "x" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (values: seq<int []>) = Interop.mkMesh3dAttr "x" (values |> Array.ofSeq)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (values: seq<seq<float>>) = Interop.mkMesh3dAttr "x" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (values: seq<float list>) = Interop.mkMesh3dAttr "x" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the X coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline x (values: seq<float []>) = Interop.mkMesh3dAttr "x" (values |> Array.ofSeq)
    ...
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (value: string) = Interop.mkMesh3dAttr "y" (value |> Array.singleton)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (values: seq<string>) = Interop.mkMesh3dAttr "y" (values |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (value: int) = Interop.mkMesh3dAttr "y" (value |> Array.singleton)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (values: seq<int>) = Interop.mkMesh3dAttr "y" (values |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (value: float) = Interop.mkMesh3dAttr "y" (value |> Array.singleton)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (values: seq<float>) = Interop.mkMesh3dAttr "y" (values |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (values: seq<seq<bool>>) = Interop.mkMesh3dAttr "y" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (values: seq<bool list>) = Interop.mkMesh3dAttr "y" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (values: seq<bool []>) = Interop.mkMesh3dAttr "y" (values |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (values: seq<seq<string>>) = Interop.mkMesh3dAttr "y" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (values: seq<string list>) = Interop.mkMesh3dAttr "y" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (values: seq<string []>) = Interop.mkMesh3dAttr "y" (values |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (values: seq<seq<int>>) = Interop.mkMesh3dAttr "y" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (values: seq<int list>) = Interop.mkMesh3dAttr "y" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (values: seq<int []>) = Interop.mkMesh3dAttr "y" (values |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (values: seq<seq<float>>) = Interop.mkMesh3dAttr "y" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (values: seq<float list>) = Interop.mkMesh3dAttr "y" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Y coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline y (values: seq<float []>) = Interop.mkMesh3dAttr "y" (values |> Array.ofSeq)
    ...
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (value: string) = Interop.mkMesh3dAttr "z" (value |> Array.singleton)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (values: seq<string>) = Interop.mkMesh3dAttr "z" (values |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (value: int) = Interop.mkMesh3dAttr "z" (value |> Array.singleton)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (values: seq<int>) = Interop.mkMesh3dAttr "z" (values |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (value: float) = Interop.mkMesh3dAttr "z" (value |> Array.singleton)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (values: seq<float>) = Interop.mkMesh3dAttr "z" (values |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (values: seq<seq<bool>>) = Interop.mkMesh3dAttr "z" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (values: seq<bool list>) = Interop.mkMesh3dAttr "z" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (values: seq<bool []>) = Interop.mkMesh3dAttr "z" (values |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (values: seq<seq<string>>) = Interop.mkMesh3dAttr "z" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (values: seq<string list>) = Interop.mkMesh3dAttr "z" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (values: seq<string []>) = Interop.mkMesh3dAttr "z" (values |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (values: seq<seq<int>>) = Interop.mkMesh3dAttr "z" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (values: seq<int list>) = Interop.mkMesh3dAttr "z" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (values: seq<int []>) = Interop.mkMesh3dAttr "z" (values |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (values: seq<seq<float>>) = Interop.mkMesh3dAttr "z" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (values: seq<float list>) = Interop.mkMesh3dAttr "z" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the Z coordinates of the vertices. The nth element of vectors `x`, `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
    static member inline z (values: seq<float []>) = Interop.mkMesh3dAttr "z" (values |> Array.ofSeq)
    ...
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (value: string) = Interop.mkMesh3dAttr "i" (value |> Array.singleton)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (values: seq<string>) = Interop.mkMesh3dAttr "i" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (value: int) = Interop.mkMesh3dAttr "i" (value |> Array.singleton)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (values: seq<int>) = Interop.mkMesh3dAttr "i" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (value: float) = Interop.mkMesh3dAttr "i" (value |> Array.singleton)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (values: seq<float>) = Interop.mkMesh3dAttr "i" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (values: seq<seq<bool>>) = Interop.mkMesh3dAttr "i" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (values: seq<bool list>) = Interop.mkMesh3dAttr "i" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (values: seq<bool []>) = Interop.mkMesh3dAttr "i" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (values: seq<seq<string>>) = Interop.mkMesh3dAttr "i" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (values: seq<string list>) = Interop.mkMesh3dAttr "i" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (values: seq<string []>) = Interop.mkMesh3dAttr "i" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (values: seq<seq<int>>) = Interop.mkMesh3dAttr "i" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (values: seq<int list>) = Interop.mkMesh3dAttr "i" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (values: seq<int []>) = Interop.mkMesh3dAttr "i" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (values: seq<seq<float>>) = Interop.mkMesh3dAttr "i" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (values: seq<float list>) = Interop.mkMesh3dAttr "i" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *first* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `i` represents a point in space, which is the first vertex of a triangle.
    static member inline i (values: seq<float []>) = Interop.mkMesh3dAttr "i" (values |> Array.ofSeq)
    ...
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (value: string) = Interop.mkMesh3dAttr "j" (value |> Array.singleton)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (values: seq<string>) = Interop.mkMesh3dAttr "j" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (value: int) = Interop.mkMesh3dAttr "j" (value |> Array.singleton)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (values: seq<int>) = Interop.mkMesh3dAttr "j" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (value: float) = Interop.mkMesh3dAttr "j" (value |> Array.singleton)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (values: seq<float>) = Interop.mkMesh3dAttr "j" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (values: seq<seq<bool>>) = Interop.mkMesh3dAttr "j" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (values: seq<bool list>) = Interop.mkMesh3dAttr "j" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (values: seq<bool []>) = Interop.mkMesh3dAttr "j" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (values: seq<seq<string>>) = Interop.mkMesh3dAttr "j" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (values: seq<string list>) = Interop.mkMesh3dAttr "j" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (values: seq<string []>) = Interop.mkMesh3dAttr "j" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (values: seq<seq<int>>) = Interop.mkMesh3dAttr "j" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (values: seq<int list>) = Interop.mkMesh3dAttr "j" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (values: seq<int []>) = Interop.mkMesh3dAttr "j" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (values: seq<seq<float>>) = Interop.mkMesh3dAttr "j" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (values: seq<float list>) = Interop.mkMesh3dAttr "j" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *second* vertex of a triangle. For example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `j` represents a point in space, which is the second vertex of a triangle.
    static member inline j (values: seq<float []>) = Interop.mkMesh3dAttr "j" (values |> Array.ofSeq)
    ...
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (value: string) = Interop.mkMesh3dAttr "k" (value |> Array.singleton)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (values: seq<string>) = Interop.mkMesh3dAttr "k" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (value: int) = Interop.mkMesh3dAttr "k" (value |> Array.singleton)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (values: seq<int>) = Interop.mkMesh3dAttr "k" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (value: float) = Interop.mkMesh3dAttr "k" (value |> Array.singleton)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (values: seq<float>) = Interop.mkMesh3dAttr "k" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (values: seq<seq<bool>>) = Interop.mkMesh3dAttr "k" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (values: seq<bool list>) = Interop.mkMesh3dAttr "k" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (values: seq<bool []>) = Interop.mkMesh3dAttr "k" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (values: seq<seq<string>>) = Interop.mkMesh3dAttr "k" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (values: seq<string list>) = Interop.mkMesh3dAttr "k" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (values: seq<string []>) = Interop.mkMesh3dAttr "k" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (values: seq<seq<int>>) = Interop.mkMesh3dAttr "k" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (values: seq<int list>) = Interop.mkMesh3dAttr "k" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (values: seq<int []>) = Interop.mkMesh3dAttr "k" (values |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (values: seq<seq<float>>) = Interop.mkMesh3dAttr "k" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (values: seq<float list>) = Interop.mkMesh3dAttr "k" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// A vector of vertex indices, i.e. integer values between 0 and the length of the vertex vectors, representing the *third* vertex of a triangle. For example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in the vertex arrays. Therefore, each element in `k` represents a point in space, which is the third vertex of a triangle.
    static member inline k (values: seq<float []>) = Interop.mkMesh3dAttr "k" (values |> Array.ofSeq)
    ...
    /// Sets the text elements associated with the vertices. If trace `hoverinfo` contains a *text* flag and *hovertext* is not set, these elements will be seen in the hover labels.
    static member inline text (values: seq<string>) = Interop.mkMesh3dAttr "text" (values |> Array.ofSeq)
    /// Same as `text`.
    static member inline hovertext (value: string) = Interop.mkMesh3dAttr "hovertext" value
    /// Same as `text`.
    static member inline hovertext (values: seq<string>) = Interop.mkMesh3dAttr "hovertext" (values |> Array.ofSeq)
    ...
    /// Template string used for rendering the information that appear on hover box. Note that this will override `hoverinfo`. Variables are inserted using %{variable}, for example \"y: %{y}\". Numbers are formatted using d3-format's syntax %{variable:d3-format}, for example \"Price: %{y:$.2f}\". https://github.com/d3/d3-3.x-api-reference/blob/master/Formatting.md#d3_format for details on the formatting syntax. Dates are formatted using d3-time-format's syntax %{variable|d3-time-format}, for example \"Day: %{2019-01-01|%A}\". https://github.com/d3/d3-3.x-api-reference/blob/master/Time-Formatting.md#format for details on the date formatting syntax. The variables available in `hovertemplate` are the ones emitted as event data described at this link https://plot.ly/javascript/plotlyjs-events/#event-data. Additionally, every attributes that can be specified per-point (the ones that are `arrayOk: true`) are available.  Anything contained in tag `<extra>` is displayed in the secondary box, for example \"<extra>{fullData.name}</extra>\". To hide the secondary box completely, use an empty tag `<extra></extra>`.
    static member inline hovertemplate (values: seq<string>) = Interop.mkMesh3dAttr "hovertemplate" (values |> Array.ofSeq)
    ...
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (value: string) = Interop.mkMesh3dAttr "intensity" (value |> Array.singleton)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (values: seq<string>) = Interop.mkMesh3dAttr "intensity" (values |> Array.ofSeq)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (value: int) = Interop.mkMesh3dAttr "intensity" (value |> Array.singleton)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (values: seq<int>) = Interop.mkMesh3dAttr "intensity" (values |> Array.ofSeq)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (value: float) = Interop.mkMesh3dAttr "intensity" (value |> Array.singleton)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (values: seq<float>) = Interop.mkMesh3dAttr "intensity" (values |> Array.ofSeq)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (values: seq<seq<bool>>) = Interop.mkMesh3dAttr "intensity" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (values: seq<bool list>) = Interop.mkMesh3dAttr "intensity" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (values: seq<bool []>) = Interop.mkMesh3dAttr "intensity" (values |> Array.ofSeq)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (values: seq<seq<string>>) = Interop.mkMesh3dAttr "intensity" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (values: seq<string list>) = Interop.mkMesh3dAttr "intensity" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (values: seq<string []>) = Interop.mkMesh3dAttr "intensity" (values |> Array.ofSeq)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (values: seq<seq<int>>) = Interop.mkMesh3dAttr "intensity" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (values: seq<int list>) = Interop.mkMesh3dAttr "intensity" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (values: seq<int []>) = Interop.mkMesh3dAttr "intensity" (values |> Array.ofSeq)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (values: seq<seq<float>>) = Interop.mkMesh3dAttr "intensity" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (values: seq<float list>) = Interop.mkMesh3dAttr "intensity" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the vertex intensity values, used for plotting fields on meshes
    static member inline intensity (values: seq<float []>) = Interop.mkMesh3dAttr "intensity" (values |> Array.ofSeq)
    ...
    static member inline vertexcolor (value: bool) = Interop.mkMesh3dAttr "vertexcolor" (value |> Array.singleton)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<bool>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Array.ofSeq)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (value: string) = Interop.mkMesh3dAttr "vertexcolor" (value |> Array.singleton)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<string>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Array.ofSeq)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (value: int) = Interop.mkMesh3dAttr "vertexcolor" (value |> Array.singleton)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<int>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Array.ofSeq)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (value: float) = Interop.mkMesh3dAttr "vertexcolor" (value |> Array.singleton)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<float>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Array.ofSeq)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<seq<bool>>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<bool list>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<bool []>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Array.ofSeq)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<seq<string>>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<string list>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<string []>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Array.ofSeq)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<seq<int>>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<int list>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<int []>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Array.ofSeq)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<seq<float>>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<float list>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each vertex Overrides *color*. While Red, green and blue colors are in the range of 0 and 255; in the case of having vertex color data in RGBA format, the alpha color should be normalized to be between 0 and 1.
    static member inline vertexcolor (values: seq<float []>) = Interop.mkMesh3dAttr "vertexcolor" (values |> Array.ofSeq)
    ...
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (value: string) = Interop.mkMesh3dAttr "facecolor" (value |> Array.singleton)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (values: seq<string>) = Interop.mkMesh3dAttr "facecolor" (values |> Array.ofSeq)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (value: int) = Interop.mkMesh3dAttr "facecolor" (value |> Array.singleton)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (values: seq<int>) = Interop.mkMesh3dAttr "facecolor" (values |> Array.ofSeq)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (value: float) = Interop.mkMesh3dAttr "facecolor" (value |> Array.singleton)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (values: seq<float>) = Interop.mkMesh3dAttr "facecolor" (values |> Array.ofSeq)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (values: seq<seq<bool>>) = Interop.mkMesh3dAttr "facecolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (values: seq<bool list>) = Interop.mkMesh3dAttr "facecolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (values: seq<bool []>) = Interop.mkMesh3dAttr "facecolor" (values |> Array.ofSeq)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (values: seq<seq<string>>) = Interop.mkMesh3dAttr "facecolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (values: seq<string list>) = Interop.mkMesh3dAttr "facecolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (values: seq<string []>) = Interop.mkMesh3dAttr "facecolor" (values |> Array.ofSeq)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (values: seq<seq<int>>) = Interop.mkMesh3dAttr "facecolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (values: seq<int list>) = Interop.mkMesh3dAttr "facecolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (values: seq<int []>) = Interop.mkMesh3dAttr "facecolor" (values |> Array.ofSeq)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (values: seq<seq<float>>) = Interop.mkMesh3dAttr "facecolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (values: seq<float list>) = Interop.mkMesh3dAttr "facecolor" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the color of each face Overrides *color* and *vertexcolor*.
    static member inline facecolor (values: seq<float []>) = Interop.mkMesh3dAttr "facecolor" (values |> Array.ofSeq)
    ...
    static member inline colorscale (value: string) = Interop.mkMesh3dAttr "colorscale" (value |> Array.singleton)
    /// Sets the colorscale. The colorscale must be an array containing arrays mapping a normalized value to an rgb, rgba, hex, hsl, hsv, or named color string. At minimum, a mapping for the lowest (0) and highest (1) values are required. For example, `[[0, 'rgb(0,0,255)'], [1, 'rgb(255,0,0)']]`. To control the bounds of the colorscale in color space, use`cmin` and `cmax`. Alternatively, `colorscale` may be a palette name string of the following list: Greys,YlGnBu,Greens,YlOrRd,Bluered,RdBu,Reds,Blues,Picnic,Rainbow,Portland,Jet,Hot,Blackbody,Earth,Electric,Viridis,Cividis.
    static member inline colorscale (values: seq<string>) = Interop.mkMesh3dAttr "colorscale" (values |> Array.ofSeq)
