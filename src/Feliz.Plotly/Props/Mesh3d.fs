...
type mesh3d =
    ...
    static member inline coloraxis (values: seq<string>) = Interop.mkMesh3dAttr "coloraxis" (values |> Array.ofSeq)
    ...
    static member inline scene (values: seq<string>) = Interop.mkMesh3dAttr "scene" (values |> Array.ofSeq)
