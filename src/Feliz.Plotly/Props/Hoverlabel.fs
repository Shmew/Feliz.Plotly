...
type hoverlabel =
    ...
    /// Sets the background color of the hover labels for this trace
    static member inline bgcolor (values: seq<int>) = Interop.mkHoverlabelAttr "bgcolor" (values |> ResizeArray)
    /// Sets the background color of the hover labels for this trace
    static member inline bgcolor (values: seq<float>) = Interop.mkHoverlabelAttr "bgcolor" (values |> ResizeArray)
    ...
    /// Sets the border color of the hover labels for this trace.
    static member inline bordercolor (values: seq<int>) = Interop.mkHoverlabelAttr "bordercolor" (values |> ResizeArray)
    /// Sets the border color of the hover labels for this trace.
    static member inline bordercolor (values: seq<float>) = Interop.mkHoverlabelAttr "bordercolor" (values |> ResizeArray)
