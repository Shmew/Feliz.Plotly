...
type fill =
    ...
    /// Sets the cell fill color. It accepts either a specific color or an array of colors or a 2D array of colors.
    static member inline color (values: seq<int>) = Interop.mkFillAttr "color" (values |> Array.ofSeq)
    /// Sets the cell fill color. It accepts either a specific color or an array of colors or a 2D array of colors.
    static member inline color (values: seq<float>) = Interop.mkFillAttr "color" (values |> Array.ofSeq)
    /// Sets the cell fill color. It accepts either a specific color or an array of colors or a 2D array of colors.
