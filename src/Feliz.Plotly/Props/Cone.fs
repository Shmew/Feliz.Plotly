...
type cone =
    ...
    static member inline coloraxis (values: seq<string>) = Interop.mkConeAttr "coloraxis" (values |> Array.ofSeq)
    ...
    static member inline scene (values: seq<string>) = Interop.mkConeAttr "scene" (values |> Array.ofSeq)
