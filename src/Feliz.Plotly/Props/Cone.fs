...
type cone =
    ...
    static member inline coloraxis (anchorId: int) = Interop.mkConeAttr "coloraxis" (sprintf "coloraxis%s" (if anchorId > 1 then (anchorId |> string) else ""))
    /// Sets a reference to a shared color axis. References to these shared color axes are *coloraxis*, *coloraxis2*, *coloraxis3*, etc. Settings for these shared color axes are set in the layout, under `layout.coloraxis`, `layout.coloraxis2`, etc. Note that multiple color scales can be linked to the same color axis.
    ...
    /// Sets the colorscale. The colorscale must be an array containing arrays mapping a normalized value to an rgb, rgba, hex, hsl, hsv, or named color string. At minimum, a mapping for the lowest (0) and highest (1) values are required. For example, `[[0, 'rgb(0,0,255)'], [1, 'rgb(255,0,0)']]`. To control the bounds of the colorscale in color space, use`cmin` and `cmax`. Alternatively, `colorscale` may be a palette name string of the following list: Greys,YlGnBu,Greens,YlOrRd,Bluered,RdBu,Reds,Blues,Picnic,Rainbow,Portland,Jet,Hot,Blackbody,Earth,Electric,Viridis,Cividis.
    static member inline colorscale (values: seq<seq<string>>) = Interop.mkConeAttr "colorscale" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the colorscale. The colorscale must be an array containing arrays mapping a normalized value to an rgb, rgba, hex, hsl, hsv, or named color string. At minimum, a mapping for the lowest (0) and highest (1) values are required. For example, `[[0, 'rgb(0,0,255)'], [1, 'rgb(255,0,0)']]`. To control the bounds of the colorscale in color space, use`cmin` and `cmax`. Alternatively, `colorscale` may be a palette name string of the following list: Greys,YlGnBu,Greens,YlOrRd,Bluered,RdBu,Reds,Blues,Picnic,Rainbow,Portland,Jet,Hot,Blackbody,Earth,Electric,Viridis,Cividis.
    static member inline colorscale (values: seq<string list>) = Interop.mkConeAttr "colorscale" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the colorscale. The colorscale must be an array containing arrays mapping a normalized value to an rgb, rgba, hex, hsl, hsv, or named color string. At minimum, a mapping for the lowest (0) and highest (1) values are required. For example, `[[0, 'rgb(0,0,255)'], [1, 'rgb(255,0,0)']]`. To control the bounds of the colorscale in color space, use`cmin` and `cmax`. Alternatively, `colorscale` may be a palette name string of the following list: Greys,YlGnBu,Greens,YlOrRd,Bluered,RdBu,Reds,Blues,Picnic,Rainbow,Portland,Jet,Hot,Blackbody,Earth,Electric,Viridis,Cividis.
    ...
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<bool>>) = Interop.mkConeAttr "customdata" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<bool list>) = Interop.mkConeAttr "customdata" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<bool []>) = Interop.mkConeAttr "customdata" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<string>>) = Interop.mkConeAttr "customdata" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<string list>) = Interop.mkConeAttr "customdata" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<string []>) = Interop.mkConeAttr "customdata" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<int>>) = Interop.mkConeAttr "customdata" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int list>) = Interop.mkConeAttr "customdata" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int []>) = Interop.mkConeAttr "customdata" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<float>>) = Interop.mkConeAttr "customdata" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<float list>) = Interop.mkConeAttr "customdata" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<float []>) = Interop.mkConeAttr "customdata" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<PlotData>) = Interop.mkConeAttr "customdata" (values |> Seq.map PlotData.asDataResize |> ResizeArray)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    ...
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<bool>>) = Interop.mkConeAttr "ids" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<bool list>) = Interop.mkConeAttr "ids" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<bool []>) = Interop.mkConeAttr "ids" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<string>>) = Interop.mkConeAttr "ids" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<string list>) = Interop.mkConeAttr "ids" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<string []>) = Interop.mkConeAttr "ids" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<int>>) = Interop.mkConeAttr "ids" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int list>) = Interop.mkConeAttr "ids" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int []>) = Interop.mkConeAttr "ids" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<float>>) = Interop.mkConeAttr "ids" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<float list>) = Interop.mkConeAttr "ids" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<float []>) = Interop.mkConeAttr "ids" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<PlotData>) = Interop.mkConeAttr "ids" (values |> Seq.map PlotData.asDataResize |> ResizeArray)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    ...
    static member inline legendgroup (value: string) = Interop.mkConeAttr "legendgroup" value
    ...
    static member inline scene (anchorId: int) = Interop.mkConeAttr "scene" (sprintf "scene%s" (if anchorId > 1 then (anchorId |> string) else ""))
    /// Sets a reference between this trace's 3D coordinate system and a 3D scene. If *scene* (the default value), the (x,y,z) coordinates refer to `layout.scene`. If *scene2*, the (x,y,z) coordinates refer to `layout.scene2`, and so on.
    static member inline scene (value: string) = Interop.mkConeAttr "scene" value
    /// Determines whether or not an item corresponding to this trace is shown in the legend.
    static member inline showlegend (value: bool) = Interop.mkConeAttr "showlegend" value
    ...
    /// Sets the x components of the vector field.
    static member inline u (values: seq<seq<bool>>) = Interop.mkConeAttr "u" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x components of the vector field.
    static member inline u (values: seq<bool list>) = Interop.mkConeAttr "u" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x components of the vector field.
    static member inline u (values: seq<bool []>) = Interop.mkConeAttr "u" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x components of the vector field.
    static member inline u (values: seq<seq<string>>) = Interop.mkConeAttr "u" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x components of the vector field.
    static member inline u (values: seq<string list>) = Interop.mkConeAttr "u" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x components of the vector field.
    static member inline u (values: seq<string []>) = Interop.mkConeAttr "u" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x components of the vector field.
    static member inline u (values: seq<seq<int>>) = Interop.mkConeAttr "u" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x components of the vector field.
    static member inline u (values: seq<int list>) = Interop.mkConeAttr "u" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x components of the vector field.
    static member inline u (values: seq<int []>) = Interop.mkConeAttr "u" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x components of the vector field.
    static member inline u (values: seq<seq<float>>) = Interop.mkConeAttr "u" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x components of the vector field.
    static member inline u (values: seq<float list>) = Interop.mkConeAttr "u" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x components of the vector field.
    static member inline u (values: seq<float []>) = Interop.mkConeAttr "u" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x components of the vector field.
    static member inline u (values: seq<PlotData>) = Interop.mkConeAttr "u" (values |> Seq.map PlotData.asDataResize |> ResizeArray)
    /// Sets the x components of the vector field.
    ...
    /// Controls persistence of some user-driven changes to the trace: `constraintrange` in `parcoords` traces, as well as some `editable: true` modifications such as `name` and `colorbar.title`. Defaults to `layout.uirevision`. Note that other user-driven trace attribute changes are controlled by `layout` attributes: `trace.visible` is controlled by `layout.legend.uirevision`, `selectedpoints` is controlled by `layout.selectionrevision`, and `colorbar.(x|y)` (accessible with `config: {editable: true}`) is controlled by `layout.editrevision`. Trace changes are tracked by `uid`, which only falls back on trace index if no `uid` is provided. So if your app can add/remove traces before the end of the `data` array, such that the same trace has a different index, you can still preserve user-driven changes if you give each trace a `uid` that stays with it as it moves.
    static member inline uirevision (values: seq<bool>) = Interop.mkConeAttr "uirevision" (values |> ResizeArray)
    /// Controls persistence of some user-driven changes to the trace: `constraintrange` in `parcoords` traces, as well as some `editable: true` modifications such as `name` and `colorbar.title`. Defaults to `layout.uirevision`. Note that other user-driven trace attribute changes are controlled by `layout` attributes: `trace.visible` is controlled by `layout.legend.uirevision`, `selectedpoints` is controlled by `layout.selectionrevision`, and `colorbar.(x|y)` (accessible with `config: {editable: true}`) is controlled by `layout.editrevision`. Trace changes are tracked by `uid`, which only falls back on trace index if no `uid` is provided. So if your app can add/remove traces before the end of the `data` array, such that the same trace has a different index, you can still preserve user-driven changes if you give each trace a `uid` that stays with it as it moves.
    ...
    /// Controls persistence of some user-driven changes to the trace: `constraintrange` in `parcoords` traces, as well as some `editable: true` modifications such as `name` and `colorbar.title`. Defaults to `layout.uirevision`. Note that other user-driven trace attribute changes are controlled by `layout` attributes: `trace.visible` is controlled by `layout.legend.uirevision`, `selectedpoints` is controlled by `layout.selectionrevision`, and `colorbar.(x|y)` (accessible with `config: {editable: true}`) is controlled by `layout.editrevision`. Trace changes are tracked by `uid`, which only falls back on trace index if no `uid` is provided. So if your app can add/remove traces before the end of the `data` array, such that the same trace has a different index, you can still preserve user-driven changes if you give each trace a `uid` that stays with it as it moves.
    static member inline uirevision (values: seq<int>) = Interop.mkConeAttr "uirevision" (values |> ResizeArray)
    /// Controls persistence of some user-driven changes to the trace: `constraintrange` in `parcoords` traces, as well as some `editable: true` modifications such as `name` and `colorbar.title`. Defaults to `layout.uirevision`. Note that other user-driven trace attribute changes are controlled by `layout` attributes: `trace.visible` is controlled by `layout.legend.uirevision`, `selectedpoints` is controlled by `layout.selectionrevision`, and `colorbar.(x|y)` (accessible with `config: {editable: true}`) is controlled by `layout.editrevision`. Trace changes are tracked by `uid`, which only falls back on trace index if no `uid` is provided. So if your app can add/remove traces before the end of the `data` array, such that the same trace has a different index, you can still preserve user-driven changes if you give each trace a `uid` that stays with it as it moves.
    static member inline uirevision (value: float) = Interop.mkConeAttr "uirevision" value
    /// Controls persistence of some user-driven changes to the trace: `constraintrange` in `parcoords` traces, as well as some `editable: true` modifications such as `name` and `colorbar.title`. Defaults to `layout.uirevision`. Note that other user-driven trace attribute changes are controlled by `layout` attributes: `trace.visible` is controlled by `layout.legend.uirevision`, `selectedpoints` is controlled by `layout.selectionrevision`, and `colorbar.(x|y)` (accessible with `config: {editable: true}`) is controlled by `layout.editrevision`. Trace changes are tracked by `uid`, which only falls back on trace index if no `uid` is provided. So if your app can add/remove traces before the end of the `data` array, such that the same trace has a different index, you can still preserve user-driven changes if you give each trace a `uid` that stays with it as it moves.
    static member inline uirevision (values: seq<float>) = Interop.mkConeAttr "uirevision" (values |> ResizeArray)
    /// Controls persistence of some user-driven changes to the trace: `constraintrange` in `parcoords` traces, as well as some `editable: true` modifications such as `name` and `colorbar.title`. Defaults to `layout.uirevision`. Note that other user-driven trace attribute changes are controlled by `layout` attributes: `trace.visible` is controlled by `layout.legend.uirevision`, `selectedpoints` is controlled by `layout.selectionrevision`, and `colorbar.(x|y)` (accessible with `config: {editable: true}`) is controlled by `layout.editrevision`. Trace changes are tracked by `uid`, which only falls back on trace index if no `uid` is provided. So if your app can add/remove traces before the end of the `data` array, such that the same trace has a different index, you can still preserve user-driven changes if you give each trace a `uid` that stays with it as it moves.
    static member inline uirevision (value: string) = Interop.mkConeAttr "uirevision" value
    /// Controls persistence of some user-driven changes to the trace: `constraintrange` in `parcoords` traces, as well as some `editable: true` modifications such as `name` and `colorbar.title`. Defaults to `layout.uirevision`. Note that other user-driven trace attribute changes are controlled by `layout` attributes: `trace.visible` is controlled by `layout.legend.uirevision`, `selectedpoints` is controlled by `layout.selectionrevision`, and `colorbar.(x|y)` (accessible with `config: {editable: true}`) is controlled by `layout.editrevision`. Trace changes are tracked by `uid`, which only falls back on trace index if no `uid` is provided. So if your app can add/remove traces before the end of the `data` array, such that the same trace has a different index, you can still preserve user-driven changes if you give each trace a `uid` that stays with it as it moves.
    static member inline uirevision (values: seq<string>) = Interop.mkConeAttr "uirevision" (values |> ResizeArray)
    ...
    /// Sets the y components of the vector field.
    static member inline v (values: seq<seq<bool>>) = Interop.mkConeAttr "v" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y components of the vector field.
    static member inline v (values: seq<bool list>) = Interop.mkConeAttr "v" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y components of the vector field.
    static member inline v (values: seq<bool []>) = Interop.mkConeAttr "v" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y components of the vector field.
    static member inline v (values: seq<seq<string>>) = Interop.mkConeAttr "v" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y components of the vector field.
    static member inline v (values: seq<string list>) = Interop.mkConeAttr "v" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y components of the vector field.
    static member inline v (values: seq<string []>) = Interop.mkConeAttr "v" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y components of the vector field.
    static member inline v (values: seq<seq<int>>) = Interop.mkConeAttr "v" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y components of the vector field.
    static member inline v (values: seq<int list>) = Interop.mkConeAttr "v" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y components of the vector field.
    static member inline v (values: seq<int []>) = Interop.mkConeAttr "v" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y components of the vector field.
    static member inline v (values: seq<seq<float>>) = Interop.mkConeAttr "v" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y components of the vector field.
    static member inline v (values: seq<float list>) = Interop.mkConeAttr "v" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y components of the vector field.
    static member inline v (values: seq<float []>) = Interop.mkConeAttr "v" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y components of the vector field.
    static member inline v (values: seq<PlotData>) = Interop.mkConeAttr "v" (values |> Seq.map PlotData.asDataResize |> ResizeArray)
    /// Sets the y components of the vector field.
    ...
    /// Sets the z components of the vector field.
    static member inline w (values: seq<seq<bool>>) = Interop.mkConeAttr "w" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z components of the vector field.
    static member inline w (values: seq<bool list>) = Interop.mkConeAttr "w" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z components of the vector field.
    static member inline w (values: seq<bool []>) = Interop.mkConeAttr "w" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z components of the vector field.
    static member inline w (values: seq<seq<string>>) = Interop.mkConeAttr "w" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z components of the vector field.
    static member inline w (values: seq<string list>) = Interop.mkConeAttr "w" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z components of the vector field.
    static member inline w (values: seq<string []>) = Interop.mkConeAttr "w" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z components of the vector field.
    static member inline w (values: seq<seq<int>>) = Interop.mkConeAttr "w" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z components of the vector field.
    static member inline w (values: seq<int list>) = Interop.mkConeAttr "w" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z components of the vector field.
    static member inline w (values: seq<int []>) = Interop.mkConeAttr "w" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z components of the vector field.
    static member inline w (values: seq<seq<float>>) = Interop.mkConeAttr "w" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z components of the vector field.
    static member inline w (values: seq<float list>) = Interop.mkConeAttr "w" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z components of the vector field.
    static member inline w (values: seq<float []>) = Interop.mkConeAttr "w" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z components of the vector field.
    static member inline w (values: seq<PlotData>) = Interop.mkConeAttr "w" (values |> Seq.map PlotData.asDataResize |> ResizeArray)
    /// Sets the z components of the vector field.
    ...
    /// Sets the x coordinates of the vector field and of the displayed cones.
    static member inline x (values: seq<seq<bool>>) = Interop.mkConeAttr "x" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x coordinates of the vector field and of the displayed cones.
    static member inline x (values: seq<bool list>) = Interop.mkConeAttr "x" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x coordinates of the vector field and of the displayed cones.
    static member inline x (values: seq<bool []>) = Interop.mkConeAttr "x" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x coordinates of the vector field and of the displayed cones.
    static member inline x (values: seq<seq<string>>) = Interop.mkConeAttr "x" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x coordinates of the vector field and of the displayed cones.
    static member inline x (values: seq<string list>) = Interop.mkConeAttr "x" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x coordinates of the vector field and of the displayed cones.
    static member inline x (values: seq<string []>) = Interop.mkConeAttr "x" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x coordinates of the vector field and of the displayed cones.
    static member inline x (values: seq<seq<int>>) = Interop.mkConeAttr "x" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x coordinates of the vector field and of the displayed cones.
    static member inline x (values: seq<int list>) = Interop.mkConeAttr "x" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x coordinates of the vector field and of the displayed cones.
    static member inline x (values: seq<int []>) = Interop.mkConeAttr "x" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x coordinates of the vector field and of the displayed cones.
    static member inline x (values: seq<seq<float>>) = Interop.mkConeAttr "x" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x coordinates of the vector field and of the displayed cones.
    static member inline x (values: seq<float list>) = Interop.mkConeAttr "x" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x coordinates of the vector field and of the displayed cones.
    static member inline x (values: seq<float []>) = Interop.mkConeAttr "x" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the x coordinates of the vector field and of the displayed cones.
    static member inline x (values: seq<PlotData>) = Interop.mkConeAttr "x" (values |> Seq.map PlotData.asDataResize |> ResizeArray)
    /// Sets the x coordinates of the vector field and of the displayed cones.
    ...
    /// Sets the y coordinates of the vector field and of the displayed cones.
    static member inline y (values: seq<seq<bool>>) = Interop.mkConeAttr "y" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y coordinates of the vector field and of the displayed cones.
    static member inline y (values: seq<bool list>) = Interop.mkConeAttr "y" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y coordinates of the vector field and of the displayed cones.
    static member inline y (values: seq<bool []>) = Interop.mkConeAttr "y" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y coordinates of the vector field and of the displayed cones.
    static member inline y (values: seq<seq<string>>) = Interop.mkConeAttr "y" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y coordinates of the vector field and of the displayed cones.
    static member inline y (values: seq<string list>) = Interop.mkConeAttr "y" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y coordinates of the vector field and of the displayed cones.
    static member inline y (values: seq<string []>) = Interop.mkConeAttr "y" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y coordinates of the vector field and of the displayed cones.
    static member inline y (values: seq<seq<int>>) = Interop.mkConeAttr "y" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y coordinates of the vector field and of the displayed cones.
    static member inline y (values: seq<int list>) = Interop.mkConeAttr "y" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y coordinates of the vector field and of the displayed cones.
    static member inline y (values: seq<int []>) = Interop.mkConeAttr "y" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y coordinates of the vector field and of the displayed cones.
    static member inline y (values: seq<seq<float>>) = Interop.mkConeAttr "y" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y coordinates of the vector field and of the displayed cones.
    static member inline y (values: seq<float list>) = Interop.mkConeAttr "y" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y coordinates of the vector field and of the displayed cones.
    static member inline y (values: seq<float []>) = Interop.mkConeAttr "y" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the y coordinates of the vector field and of the displayed cones.
    static member inline y (values: seq<PlotData>) = Interop.mkConeAttr "y" (values |> Seq.map PlotData.asDataResize |> ResizeArray)
    /// Sets the y coordinates of the vector field and of the displayed cones.
    ...
    /// Sets the z coordinates of the vector field and of the displayed cones.
    static member inline z (values: seq<seq<bool>>) = Interop.mkConeAttr "z" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z coordinates of the vector field and of the displayed cones.
    static member inline z (values: seq<bool list>) = Interop.mkConeAttr "z" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z coordinates of the vector field and of the displayed cones.
    static member inline z (values: seq<bool []>) = Interop.mkConeAttr "z" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z coordinates of the vector field and of the displayed cones.
    static member inline z (values: seq<seq<string>>) = Interop.mkConeAttr "z" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z coordinates of the vector field and of the displayed cones.
    static member inline z (values: seq<string list>) = Interop.mkConeAttr "z" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z coordinates of the vector field and of the displayed cones.
    static member inline z (values: seq<string []>) = Interop.mkConeAttr "z" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z coordinates of the vector field and of the displayed cones.
    static member inline z (values: seq<seq<int>>) = Interop.mkConeAttr "z" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z coordinates of the vector field and of the displayed cones.
    static member inline z (values: seq<int list>) = Interop.mkConeAttr "z" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z coordinates of the vector field and of the displayed cones.
    static member inline z (values: seq<int []>) = Interop.mkConeAttr "z" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z coordinates of the vector field and of the displayed cones.
    static member inline z (values: seq<seq<float>>) = Interop.mkConeAttr "z" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z coordinates of the vector field and of the displayed cones.
    static member inline z (values: seq<float list>) = Interop.mkConeAttr "z" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z coordinates of the vector field and of the displayed cones.
    static member inline z (values: seq<float []>) = Interop.mkConeAttr "z" (values |> Seq.map ResizeArray |> ResizeArray)
    /// Sets the z coordinates of the vector field and of the displayed cones.
    static member inline z (values: seq<PlotData>) = Interop.mkConeAttr "z" (values |> Seq.map PlotData.asDataResize |> ResizeArray)
    /// Sets the z coordinates of the vector field and of the displayed cones.
