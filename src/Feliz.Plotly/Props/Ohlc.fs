...
type ohlc =
    ...
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<bool>>) = Interop.mkOhlcAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<bool list>) = Interop.mkOhlcAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<bool []>) = Interop.mkOhlcAttr "ids" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<string>>) = Interop.mkOhlcAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<string list>) = Interop.mkOhlcAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<string []>) = Interop.mkOhlcAttr "ids" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<int>>) = Interop.mkOhlcAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int list>) = Interop.mkOhlcAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int option []>) = Interop.mkOhlcAttr "ids" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<float>>) = Interop.mkOhlcAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<float list>) = Interop.mkOhlcAttr "ids" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<float []>) = Interop.mkOhlcAttr "ids" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<U4<int [], float [], string [], bool []>>) = Interop.mkOhlcAttr "ids" (values |> Seq.map U4.mapArrayToResize |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<U4<int list, float list, string list, bool list>>) = Interop.mkOhlcAttr "ids" (values |> Seq.map U4.mapListToResize |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    ...
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<bool>>) = Interop.mkOhlcAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<bool list>) = Interop.mkOhlcAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<bool []>) = Interop.mkOhlcAttr "customdata" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<string>>) = Interop.mkOhlcAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<string list>) = Interop.mkOhlcAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<string []>) = Interop.mkOhlcAttr "customdata" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<int>>) = Interop.mkOhlcAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int list>) = Interop.mkOhlcAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int option []>) = Interop.mkOhlcAttr "customdata" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<float>>) = Interop.mkOhlcAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<float list>) = Interop.mkOhlcAttr "customdata" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<float []>) = Interop.mkOhlcAttr "customdata" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<U4<int [], float [], string [], bool []>>) = Interop.mkOhlcAttr "customdata" (values |> Seq.map U4.mapArrayToResize |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<U4<int list, float list, string list, bool list>>) = Interop.mkOhlcAttr "customdata" (values |> Seq.map U4.mapListToResize |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    ...
    /// Array containing integer indices of selected points. Has an effect only for traces that support selections. Note that an empty array means an empty selection where the `unselected` are turned on for all points, whereas, any other non-array values means no selection all where the `selected` and `unselected` styles have no effect.
    static member inline selectedpoints (values: seq<System.DateTime>) = Interop.mkOhlcAttr "selectedpoints" (values |> Array.ofSeq)
    /// Array containing integer indices of selected points. Has an effect only for traces that support selections. Note that an empty array means an empty selection where the `unselected` are turned on for all points, whereas, any other non-array values means no selection all where the `selected` and `unselected` styles have no effect.
    ...
    /// Controls persistence of some user-driven changes to the trace: `constraintrange` in `parcoords` traces, as well as some `editable: true` modifications such as `name` and `colorbar.title`. Defaults to `layout.uirevision`. Note that other user-driven trace attribute changes are controlled by `layout` attributes: `trace.visible` is controlled by `layout.legend.uirevision`, `selectedpoints` is controlled by `layout.selectionrevision`, and `colorbar.(x|y)` (accessible with `config: {editable: true}`) is controlled by `layout.editrevision`. Trace changes are tracked by `uid`, which only falls back on trace index if no `uid` is provided. So if your app can add/remove traces before the end of the `data` array, such that the same trace has a different index, you can still preserve user-driven changes if you give each trace a `uid` that stays with it as it moves.
    static member inline uirevision (values: seq<System.DateTime>) = Interop.mkOhlcAttr "uirevision" (values |> Array.ofSeq)
    /// Controls persistence of some user-driven changes to the trace: `constraintrange` in `parcoords` traces, as well as some `editable: true` modifications such as `name` and `colorbar.title`. Defaults to `layout.uirevision`. Note that other user-driven trace attribute changes are controlled by `layout` attributes: `trace.visible` is controlled by `layout.legend.uirevision`, `selectedpoints` is controlled by `layout.selectionrevision`, and `colorbar.(x|y)` (accessible with `config: {editable: true}`) is controlled by `layout.editrevision`. Trace changes are tracked by `uid`, which only falls back on trace index if no `uid` is provided. So if your app can add/remove traces before the end of the `data` array, such that the same trace has a different index, you can still preserve user-driven changes if you give each trace a `uid` that stays with it as it moves.
    ...
    /// Sets the x coordinates. If absent, linear coordinate will be generated.
    static member inline x (values: seq<bool list>) = Interop.mkOhlcAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the x coordinates. If absent, linear coordinate will be generated.
    static member inline x (values: seq<bool []>) = Interop.mkOhlcAttr "x" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the x coordinates. If absent, linear coordinate will be generated.
    static member inline x (values: seq<seq<string>>) = Interop.mkOhlcAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the x coordinates. If absent, linear coordinate will be generated.
    static member inline x (values: seq<string list>) = Interop.mkOhlcAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the x coordinates. If absent, linear coordinate will be generated.
    static member inline x (values: seq<string []>) = Interop.mkOhlcAttr "x" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the x coordinates. If absent, linear coordinate will be generated.
    static member inline x (values: seq<seq<int>>) = Interop.mkOhlcAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the x coordinates. If absent, linear coordinate will be generated.
    static member inline x (values: seq<int list>) = Interop.mkOhlcAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the x coordinates. If absent, linear coordinate will be generated.
    static member inline x (values: seq<int option []>) = Interop.mkOhlcAttr "x" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the x coordinates. If absent, linear coordinate will be generated.
    static member inline x (values: seq<seq<float>>) = Interop.mkOhlcAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the x coordinates. If absent, linear coordinate will be generated.
    static member inline x (values: seq<float list>) = Interop.mkOhlcAttr "x" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the x coordinates. If absent, linear coordinate will be generated.
    static member inline x (values: seq<float []>) = Interop.mkOhlcAttr "x" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the x coordinates. If absent, linear coordinate will be generated.
    static member inline x (values: seq<U4<int [], float [], string [], bool []>>) = Interop.mkOhlcAttr "x" (values |> Seq.map U4.mapArrayToResize |> Array.ofSeq)
    /// Sets the x coordinates. If absent, linear coordinate will be generated.
    static member inline x (values: seq<U4<int list, float list, string list, bool list>>) = Interop.mkOhlcAttr "x" (values |> Seq.map U4.mapListToResize |> Array.ofSeq)
    /// Sets the x coordinates. If absent, linear coordinate will be generated.
    ...
    /// Sets the open values.
    static member inline open' (values: seq<seq<bool>>) = Interop.mkOhlcAttr "open" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the open values.
    static member inline open' (values: seq<bool list>) = Interop.mkOhlcAttr "open" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the open values.
    static member inline open' (values: seq<bool []>) = Interop.mkOhlcAttr "open" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the open values.
    static member inline open' (values: seq<seq<string>>) = Interop.mkOhlcAttr "open" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the open values.
    static member inline open' (values: seq<string list>) = Interop.mkOhlcAttr "open" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the open values.
    static member inline open' (values: seq<string []>) = Interop.mkOhlcAttr "open" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the open values.
    static member inline open' (values: seq<seq<int>>) = Interop.mkOhlcAttr "open" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the open values.
    static member inline open' (values: seq<int list>) = Interop.mkOhlcAttr "open" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the open values.
    static member inline open' (values: seq<int option []>) = Interop.mkOhlcAttr "open" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the open values.
    static member inline open' (values: seq<seq<float>>) = Interop.mkOhlcAttr "open" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the open values.
    static member inline open' (values: seq<float list>) = Interop.mkOhlcAttr "open" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the open values.
    static member inline open' (values: seq<float []>) = Interop.mkOhlcAttr "open" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the open values.
    static member inline open' (values: seq<U4<int [], float [], string [], bool []>>) = Interop.mkOhlcAttr "open" (values |> Seq.map U4.mapArrayToResize |> Array.ofSeq)
    /// Sets the open values.
    static member inline open' (values: seq<U4<int list, float list, string list, bool list>>) = Interop.mkOhlcAttr "open" (values |> Seq.map U4.mapListToResize |> Array.ofSeq)
    /// Sets the open values.
    ...
    /// Sets the high values.
    static member inline high (values: seq<seq<bool>>) = Interop.mkOhlcAttr "high" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the high values.
    static member inline high (values: seq<bool list>) = Interop.mkOhlcAttr "high" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the high values.
    static member inline high (values: seq<bool []>) = Interop.mkOhlcAttr "high" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the high values.
    static member inline high (values: seq<seq<string>>) = Interop.mkOhlcAttr "high" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the high values.
    static member inline high (values: seq<string list>) = Interop.mkOhlcAttr "high" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the high values.
    static member inline high (values: seq<string []>) = Interop.mkOhlcAttr "high" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the high values.
    static member inline high (values: seq<seq<int>>) = Interop.mkOhlcAttr "high" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the high values.
    static member inline high (values: seq<int list>) = Interop.mkOhlcAttr "high" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the high values.
    static member inline high (values: seq<int option []>) = Interop.mkOhlcAttr "high" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the high values.
    static member inline high (values: seq<seq<float>>) = Interop.mkOhlcAttr "high" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the high values.
    static member inline high (values: seq<float list>) = Interop.mkOhlcAttr "high" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the high values.
    static member inline high (values: seq<float []>) = Interop.mkOhlcAttr "high" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the high values.
    static member inline high (values: seq<U4<int [], float [], string [], bool []>>) = Interop.mkOhlcAttr "high" (values |> Seq.map U4.mapArrayToResize |> Array.ofSeq)
    /// Sets the high values.
    static member inline high (values: seq<U4<int list, float list, string list, bool list>>) = Interop.mkOhlcAttr "high" (values |> Seq.map U4.mapListToResize |> Array.ofSeq)
    /// Sets the high values.
    ...
    /// Sets the low values.
    static member inline low (values: seq<seq<bool>>) = Interop.mkOhlcAttr "low" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the low values.
    static member inline low (values: seq<bool list>) = Interop.mkOhlcAttr "low" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the low values.
    static member inline low (values: seq<bool []>) = Interop.mkOhlcAttr "low" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the low values.
    static member inline low (values: seq<seq<string>>) = Interop.mkOhlcAttr "low" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the low values.
    static member inline low (values: seq<string list>) = Interop.mkOhlcAttr "low" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the low values.
    static member inline low (values: seq<string []>) = Interop.mkOhlcAttr "low" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the low values.
    static member inline low (values: seq<seq<int>>) = Interop.mkOhlcAttr "low" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the low values.
    static member inline low (values: seq<int list>) = Interop.mkOhlcAttr "low" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the low values.
    static member inline low (values: seq<int option []>) = Interop.mkOhlcAttr "low" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the low values.
    static member inline low (values: seq<seq<float>>) = Interop.mkOhlcAttr "low" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the low values.
    static member inline low (values: seq<float list>) = Interop.mkOhlcAttr "low" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the low values.
    static member inline low (values: seq<float []>) = Interop.mkOhlcAttr "low" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the low values.
    static member inline low (values: seq<U4<int [], float [], string [], bool []>>) = Interop.mkOhlcAttr "low" (values |> Seq.map U4.mapArrayToResize |> Array.ofSeq)
    /// Sets the low values.
    static member inline low (values: seq<U4<int list, float list, string list, bool list>>) = Interop.mkOhlcAttr "low" (values |> Seq.map U4.mapListToResize |> Array.ofSeq)
    /// Sets the low values.
    ...
    /// Sets the close values.
    static member inline close (values: seq<seq<bool>>) = Interop.mkOhlcAttr "close" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the close values.
    static member inline close (values: seq<bool list>) = Interop.mkOhlcAttr "close" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the close values.
    static member inline close (values: seq<bool []>) = Interop.mkOhlcAttr "close" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the close values.
    static member inline close (values: seq<seq<string>>) = Interop.mkOhlcAttr "close" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the close values.
    static member inline close (values: seq<string list>) = Interop.mkOhlcAttr "close" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the close values.
    static member inline close (values: seq<string []>) = Interop.mkOhlcAttr "close" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the close values.
    static member inline close (values: seq<seq<int>>) = Interop.mkOhlcAttr "close" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the close values.
    static member inline close (values: seq<int list>) = Interop.mkOhlcAttr "close" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the close values.
    static member inline close (values: seq<int option []>) = Interop.mkOhlcAttr "close" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the close values.
    static member inline close (values: seq<seq<float>>) = Interop.mkOhlcAttr "close" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the close values.
    static member inline close (values: seq<float list>) = Interop.mkOhlcAttr "close" (values |> Seq.map (Array.ofSeq >> ResizeArray) |> Array.ofSeq)
    /// Sets the close values.
    static member inline close (values: seq<float []>) = Interop.mkOhlcAttr "close" (values |> Seq.map ResizeArray |> Array.ofSeq)
    /// Sets the close values.
    static member inline close (values: seq<U4<int [], float [], string [], bool []>>) = Interop.mkOhlcAttr "close" (values |> Seq.map U4.mapArrayToResize |> Array.ofSeq)
    /// Sets the close values.
    static member inline close (values: seq<U4<int list, float list, string list, bool list>>) = Interop.mkOhlcAttr "close" (values |> Seq.map U4.mapListToResize |> Array.ofSeq)
    /// Sets the close values.
