...
type scatterpolargl =
    ...
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<bool>>) = Interop.mkScatterpolarglAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<bool list>) = Interop.mkScatterpolarglAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<bool []>) = Interop.mkScatterpolarglAttr "ids" (values |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<string>>) = Interop.mkScatterpolarglAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<string list>) = Interop.mkScatterpolarglAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<string []>) = Interop.mkScatterpolarglAttr "ids" (values |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<int>>) = Interop.mkScatterpolarglAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int list>) = Interop.mkScatterpolarglAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<int []>) = Interop.mkScatterpolarglAttr "ids" (values |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<seq<float>>) = Interop.mkScatterpolarglAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<float list>) = Interop.mkScatterpolarglAttr "ids" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
    static member inline ids (values: seq<float []>) = Interop.mkScatterpolarglAttr "ids" (values |> Array.ofSeq)
    ...
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<bool>>) = Interop.mkScatterpolarglAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<bool list>) = Interop.mkScatterpolarglAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<bool []>) = Interop.mkScatterpolarglAttr "customdata" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<string>>) = Interop.mkScatterpolarglAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<string list>) = Interop.mkScatterpolarglAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<string []>) = Interop.mkScatterpolarglAttr "customdata" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<int>>) = Interop.mkScatterpolarglAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int list>) = Interop.mkScatterpolarglAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<int []>) = Interop.mkScatterpolarglAttr "customdata" (values |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<seq<float>>) = Interop.mkScatterpolarglAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<float list>) = Interop.mkScatterpolarglAttr "customdata" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
    static member inline customdata (values: seq<float []>) = Interop.mkScatterpolarglAttr "customdata" (values |> Array.ofSeq)
    ...
    static member inline transforms (properties: #ITransformsProperty list) = Interop.mkScatterpolarglAttr "transforms" (createObj !!properties)
    ...
    /// Sets the radial coordinates
    static member inline r (values: seq<bool>) = Interop.mkScatterpolarglAttr "r" (values |> Array.ofSeq)
    /// Sets the radial coordinates
    static member inline r (value: string) = Interop.mkScatterpolarglAttr "r" (value |> Array.singleton)
    /// Sets the radial coordinates
    static member inline r (values: seq<string>) = Interop.mkScatterpolarglAttr "r" (values |> Array.ofSeq)
    /// Sets the radial coordinates
    static member inline r (value: int) = Interop.mkScatterpolarglAttr "r" (value |> Array.singleton)
    /// Sets the radial coordinates
    static member inline r (values: seq<int>) = Interop.mkScatterpolarglAttr "r" (values |> Array.ofSeq)
    /// Sets the radial coordinates
    static member inline r (value: float) = Interop.mkScatterpolarglAttr "r" (value |> Array.singleton)
    /// Sets the radial coordinates
    static member inline r (values: seq<float>) = Interop.mkScatterpolarglAttr "r" (values |> Array.ofSeq)
    /// Sets the radial coordinates
    static member inline r (values: seq<seq<bool>>) = Interop.mkScatterpolarglAttr "r" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the radial coordinates
    static member inline r (values: seq<bool list>) = Interop.mkScatterpolarglAttr "r" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the radial coordinates
    static member inline r (values: seq<bool []>) = Interop.mkScatterpolarglAttr "r" (values |> Array.ofSeq)
    /// Sets the radial coordinates
    static member inline r (values: seq<seq<string>>) = Interop.mkScatterpolarglAttr "r" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the radial coordinates
    static member inline r (values: seq<string list>) = Interop.mkScatterpolarglAttr "r" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the radial coordinates
    static member inline r (values: seq<string []>) = Interop.mkScatterpolarglAttr "r" (values |> Array.ofSeq)
    /// Sets the radial coordinates
    static member inline r (values: seq<seq<int>>) = Interop.mkScatterpolarglAttr "r" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the radial coordinates
    static member inline r (values: seq<int list>) = Interop.mkScatterpolarglAttr "r" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the radial coordinates
    static member inline r (values: seq<int []>) = Interop.mkScatterpolarglAttr "r" (values |> Array.ofSeq)
    /// Sets the radial coordinates
    static member inline r (values: seq<seq<float>>) = Interop.mkScatterpolarglAttr "r" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the radial coordinates
    static member inline r (values: seq<float list>) = Interop.mkScatterpolarglAttr "r" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the radial coordinates
    static member inline r (values: seq<float []>) = Interop.mkScatterpolarglAttr "r" (values |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (value: bool) = Interop.mkScatterpolarglAttr "theta" (value |> Array.singleton)
    /// Sets the angular coordinates
    static member inline theta (values: seq<bool>) = Interop.mkScatterpolarglAttr "theta" (values |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (value: string) = Interop.mkScatterpolarglAttr "theta" (value |> Array.singleton)
    /// Sets the angular coordinates
    static member inline theta (values: seq<string>) = Interop.mkScatterpolarglAttr "theta" (values |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (value: int) = Interop.mkScatterpolarglAttr "theta" (value |> Array.singleton)
    /// Sets the angular coordinates
    static member inline theta (values: seq<int>) = Interop.mkScatterpolarglAttr "theta" (values |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (value: float) = Interop.mkScatterpolarglAttr "theta" (value |> Array.singleton)
    /// Sets the angular coordinates
    static member inline theta (values: seq<float>) = Interop.mkScatterpolarglAttr "theta" (values |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (values: seq<seq<bool>>) = Interop.mkScatterpolarglAttr "theta" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (values: seq<bool list>) = Interop.mkScatterpolarglAttr "theta" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (values: seq<bool []>) = Interop.mkScatterpolarglAttr "theta" (values |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (values: seq<seq<string>>) = Interop.mkScatterpolarglAttr "theta" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (values: seq<string list>) = Interop.mkScatterpolarglAttr "theta" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (values: seq<string []>) = Interop.mkScatterpolarglAttr "theta" (values |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (values: seq<seq<int>>) = Interop.mkScatterpolarglAttr "theta" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (values: seq<int list>) = Interop.mkScatterpolarglAttr "theta" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (values: seq<int []>) = Interop.mkScatterpolarglAttr "theta" (values |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (values: seq<seq<float>>) = Interop.mkScatterpolarglAttr "theta" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (values: seq<float list>) = Interop.mkScatterpolarglAttr "theta" (values |> Seq.map Array.ofSeq |> Array.ofSeq)
    /// Sets the angular coordinates
    static member inline theta (values: seq<float []>) = Interop.mkScatterpolarglAttr "theta" (values |> Array.ofSeq)
    ...
    /// Sets text elements associated with each (x,y) pair. If a single string, the same string appears over all the data points. If an array of string, the items are mapped in order to the this trace's (x,y) coordinates. If trace `hoverinfo` contains a *text* flag and *hovertext* is not set, these elements will be seen in the hover labels.
    static member inline text (values: seq<string>) = Interop.mkScatterpolarglAttr "text" (values |> Array.ofSeq)
    ...
    /// Template string used for rendering the information text that appear on points. Note that this will override `textinfo`. Variables are inserted using %{variable}, for example \"y: %{y}\". Numbers are formatted using d3-format's syntax %{variable:d3-format}, for example \"Price: %{y:$.2f}\". https://github.com/d3/d3-3.x-api-reference/blob/master/Formatting.md#d3_format for details on the formatting syntax. Dates are formatted using d3-time-format's syntax %{variable|d3-time-format}, for example \"Day: %{2019-01-01|%A}\". https://github.com/d3/d3-3.x-api-reference/blob/master/Time-Formatting.md#format for details on the date formatting syntax. Every attributes that can be specified per-point (the ones that are `arrayOk: true`) are available. variables `r`, `theta` and `text`.
    static member inline texttemplate (values: seq<string>) = Interop.mkScatterpolarglAttr "texttemplate" (values |> Array.ofSeq)
    ...
    /// Sets hover text elements associated with each (x,y) pair. If a single string, the same string appears over all the data points. If an array of string, the items are mapped in order to the this trace's (x,y) coordinates. To be seen, trace `hoverinfo` must contain a *text* flag.
    static member inline hovertext (values: seq<string>) = Interop.mkScatterpolarglAttr "hovertext" (values |> Array.ofSeq)
    ...
    /// Template string used for rendering the information that appear on hover box. Note that this will override `hoverinfo`. Variables are inserted using %{variable}, for example \"y: %{y}\". Numbers are formatted using d3-format's syntax %{variable:d3-format}, for example \"Price: %{y:$.2f}\". https://github.com/d3/d3-3.x-api-reference/blob/master/Formatting.md#d3_format for details on the formatting syntax. Dates are formatted using d3-time-format's syntax %{variable|d3-time-format}, for example \"Day: %{2019-01-01|%A}\". https://github.com/d3/d3-3.x-api-reference/blob/master/Time-Formatting.md#format for details on the date formatting syntax. The variables available in `hovertemplate` are the ones emitted as event data described at this link https://plot.ly/javascript/plotlyjs-events/#event-data. Additionally, every attributes that can be specified per-point (the ones that are `arrayOk: true`) are available.  Anything contained in tag `<extra>` is displayed in the secondary box, for example \"<extra>{fullData.name}</extra>\". To hide the secondary box completely, use an empty tag `<extra></extra>`.
    static member inline hovertemplate (values: seq<string>) = Interop.mkScatterpolarglAttr "hovertemplate" (values |> Array.ofSeq)
...
module scatterpolargl =
    ...
    let inline textpositions (properties: #IScatterpolarglProperty list) = properties |> List.map (Bindings.getKV >> snd) |> ResizeArray |> Interop.mkScatterpolarglAttr "textposition"
