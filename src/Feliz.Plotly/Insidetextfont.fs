...
type insidetextfont =
    ...
    static member inline color (values: seq<int>) = Interop.mkInsidetextfontAttr "color" (values |> ResizeArray)
    static member inline color (values: seq<float>) = Interop.mkInsidetextfontAttr "color" (values |> ResizeArray)
...
module insidetextfont =
    [<Erase>]
    type color =
        static member inline rgb (r,g,b) = Interop.mkInsidetextfontAttr "color" (Feliz.color.rgb(r,g,b))
        static member inline rgba (r,g,b,a) = Interop.mkInsidetextfontAttr "color" (Feliz.color.rgba(r,g,b,a))
        static member inline hsl (h,s,l) = Interop.mkInsidetextfontAttr "color" (Feliz.color.hsl(h,s,l))
