...
type framesEntry =
    ...
    /// A list of traces this frame modifies. The format is identical to the normal trace definition.
    static member inline data (values: seq<bool>) = Interop.mkFramesEntryAttr "data" (values |> ResizeArray)
    /// A list of traces this frame modifies. The format is identical to the normal trace definition.
    ...
    /// A list of traces this frame modifies. The format is identical to the normal trace definition.
    static member inline data (values: seq<int>) = Interop.mkFramesEntryAttr "data" (values |> ResizeArray)
    /// A list of traces this frame modifies. The format is identical to the normal trace definition.
    static member inline data (value: float) = Interop.mkFramesEntryAttr "data" value
    /// A list of traces this frame modifies. The format is identical to the normal trace definition.
    static member inline data (values: seq<float>) = Interop.mkFramesEntryAttr "data" (values |> ResizeArray)
    /// A list of traces this frame modifies. The format is identical to the normal trace definition.
    static member inline data (value: string) = Interop.mkFramesEntryAttr "data" value
    /// A list of traces this frame modifies. The format is identical to the normal trace definition.
    static member inline data (values: seq<string>) = Interop.mkFramesEntryAttr "data" (values |> ResizeArray)
    ...
    /// Layout properties which this frame modifies. The format is identical to the normal layout definition.
    static member inline layout (values: seq<bool>) = Interop.mkFramesEntryAttr "layout" (values |> ResizeArray)
    /// Layout properties which this frame modifies. The format is identical to the normal layout definition.
    ...
    /// Layout properties which this frame modifies. The format is identical to the normal layout definition.
    static member inline layout (values: seq<int>) = Interop.mkFramesEntryAttr "layout" (values |> ResizeArray)
    /// Layout properties which this frame modifies. The format is identical to the normal layout definition.
    static member inline layout (value: float) = Interop.mkFramesEntryAttr "layout" value
    /// Layout properties which this frame modifies. The format is identical to the normal layout definition.
    static member inline layout (values: seq<float>) = Interop.mkFramesEntryAttr "layout" (values |> ResizeArray)
    /// Layout properties which this frame modifies. The format is identical to the normal layout definition.
    static member inline layout (value: string) = Interop.mkFramesEntryAttr "layout" value
    /// Layout properties which this frame modifies. The format is identical to the normal layout definition.
    static member inline layout (values: seq<string>) = Interop.mkFramesEntryAttr "layout" (values |> ResizeArray)
