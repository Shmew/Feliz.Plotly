...
type isosurface =
    ...
    /// Sets the 4th dimension (value) of the vertices.
    static member inline value (value: System.DateTime) = Interop.mkIsosurfaceAttr "value" (value |> Array.singleton)
    /// Sets the 4th dimension (value) of the vertices.
    ...
    /// Sets the X coordinates of the vertices on X axis.
    static member inline x (value: System.DateTime) = Interop.mkIsosurfaceAttr "x" (value |> Array.singleton)
    /// Sets the X coordinates of the vertices on X axis.
    ...
    /// Sets the Y coordinates of the vertices on Y axis.
    static member inline y (value: System.DateTime) = Interop.mkIsosurfaceAttr "y" (value |> Array.singleton)
    /// Sets the Y coordinates of the vertices on Y axis.
    ...
    /// Sets the Z coordinates of the vertices on Z axis.
    static member inline z (value: System.DateTime) = Interop.mkIsosurfaceAttr "z" (value |> Array.singleton)
    /// Sets the Z coordinates of the vertices on Z axis.
