...
module Bindings =
    ...
    module rec Plotly =
        ...
        let [<Import("Plots","plotly.js")>] Plots: StaticPlots = jsNative
        let [<Import("d3","plotly.js")>] d3: obj = jsNative
        let plotly : IExports =  importAll "plotly.js"
    
        type [<AllowNullLiteral>] IExports =
            abstract newPlot: root: Root * data: ResizeArray<Data> * ?layout: obj * ?config: obj -> Promise<PlotlyHTMLElement>
            [<Obsolete("Deprecated in favor of Plotly.react")>]
            ...
            abstract restyle: root: Root * obj * ?traces: U2<ResizeArray<float>, float> -> Promise<PlotlyHTMLElement>
            ...
            abstract addFrames: root: Root * frames: obj [] -> Promise<PlotlyHTMLElement>
