    ...
    Plotly.plot [
        plot.data [
            data.scatter [
                ...
                scatter.marker [
                    scatter.marker.size [ 400; 600; 800; 1000 ]
            ...
            data.scatter [
                ...
                scatter.marker [
                    ...
                    scatter.marker.sizeref sizeRef
                    scatter.marker.sizemode.area
                ]
            ]
        ]
        plot.layout [
            layout.title [
                layout.title.text "Bubble Chart Size Scaling"
            ]
